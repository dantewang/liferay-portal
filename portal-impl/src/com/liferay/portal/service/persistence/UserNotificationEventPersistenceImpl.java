...
public class UserNotificationEventPersistenceImpl extends BasePersistenceImpl<UserNotificationEvent>
	...
	public List<UserNotificationEvent> findByUuid(String uuid, int start,
		...
		List<UserNotificationEvent> list = (List<UserNotificationEvent>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID,
				finderArgs, this);
	...
	public List<UserNotificationEvent> findByUuid_C(String uuid,
		...
		List<UserNotificationEvent> list = (List<UserNotificationEvent>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID_C,
				finderArgs, this);
	...
	public List<UserNotificationEvent> findByUserId(long userId, int start,
		...
		List<UserNotificationEvent> list = (List<UserNotificationEvent>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_USERID,
				finderArgs, this);
	...
	public List<UserNotificationEvent> findByU_A(long userId, boolean archived,
		...
		List<UserNotificationEvent> list = (List<UserNotificationEvent>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_U_A,
				finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				if (list == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_U_A,
						finderArgs);
				}
				else {
					cacheResult(list);

					FinderCacheUtil.putResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_U_A,
						finderArgs, list);
				}
	...
	public List<UserNotificationEvent> findAll(int start, int end,
		...
		List<UserNotificationEvent> list = (List<UserNotificationEvent>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_ALL,
				finderArgs, this);
