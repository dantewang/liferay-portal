		...
		if (list == null) {
			...
			try {
				...
				if (list == null) {
					...
					FinderCacheUtil.putResult(FINDER_PATH_FIND_BY_C_CD,
						finderArgs, list);
				}
		...
		if (list == null) {
			...
			try {
				...
				if (list == null) {
					...
					FinderCacheUtil.putResult(FINDER_PATH_FIND_BY_C_MD,
						finderArgs, list);
				}
		...
		if (list == null) {
			...
			try {
				...
				if (list == null) {
					...
					FinderCacheUtil.putResult(FINDER_PATH_FIND_BY_C_DU,
						finderArgs, list);
				}
	...
	protected List<User> findByC_O(long companyId, String openId, int start,
		...
		if (list == null) {
			...
			try {
				...
				if (list == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_C_O,
						finderArgs);
				}
				else {
					cacheResult(list);

					FinderCacheUtil.putResult(FINDER_PATH_FIND_BY_C_O,
						finderArgs, list);
				}
