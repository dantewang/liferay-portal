...
public class LayoutRevisionPersistenceImpl extends BasePersistenceImpl<LayoutRevision>
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_LAYOUTSETBRANCHID = new FinderPath(LayoutRevisionModelImpl.ENTITY_CACHE_ENABLED,
			LayoutRevisionModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_COUNT, "countByLayoutSetBranchId",
	...
	public int countByPlid(long plid) throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_PLID,
					finderArgs);
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_L_H = new FinderPath(LayoutRevisionModelImpl.ENTITY_CACHE_ENABLED,
			LayoutRevisionModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_COUNT, "countByL_H",
	...
	public List<LayoutRevision> findByL_H(long layoutSetBranchId, boolean head,
		...
		if (list == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_FIND_BY_L_H, finderArgs,
					list);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_L_H, finderArgs);
	...
	public int countByL_H(long layoutSetBranchId, boolean head)
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_L_H,
					finderArgs);
	...
	public List<LayoutRevision> findByL_P(long layoutSetBranchId, long plid,
		...
		if (list == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_L_P, finderArgs);
	...
	public int countByL_P(long layoutSetBranchId, long plid)
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_L_P,
					finderArgs);
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_L_S = new FinderPath(LayoutRevisionModelImpl.ENTITY_CACHE_ENABLED,
			LayoutRevisionModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_COUNT, "countByL_S",
	...
	public List<LayoutRevision> findByL_S(long layoutSetBranchId, int status,
		...
		if (list == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_FIND_BY_L_S, finderArgs,
					list);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_L_S, finderArgs);
	...
	public int countByL_S(long layoutSetBranchId, int status)
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_L_S,
					finderArgs);
	...
	public static final FinderPath FINDER_PATH_FIND_BY_H_P = new FinderPath(LayoutRevisionModelImpl.ENTITY_CACHE_ENABLED,
			LayoutRevisionModelImpl.FINDER_CACHE_ENABLED,
			LayoutRevisionImpl.class, FINDER_CLASS_NAME_LIST, "findByH_P",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_H_P = new FinderPath(LayoutRevisionModelImpl.ENTITY_CACHE_ENABLED,
			LayoutRevisionModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_COUNT, "countByH_P",
	...
	public List<LayoutRevision> findByH_P(boolean head, long plid, int start,
		...
		List<LayoutRevision> list = (List<LayoutRevision>)FinderCacheUtil.getResult(FINDER_PATH_FIND_BY_H_P,
				finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_FIND_BY_H_P, finderArgs,
					list);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_H_P, finderArgs);
	...
	public int countByH_P(boolean head, long plid) throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_H_P,
					finderArgs);
	...
	public static final FinderPath FINDER_PATH_FIND_BY_P_NOTS = new FinderPath(LayoutRevisionModelImpl.ENTITY_CACHE_ENABLED,
			LayoutRevisionModelImpl.FINDER_CACHE_ENABLED,
			LayoutRevisionImpl.class, FINDER_CLASS_NAME_LIST, "findByP_NotS",
			new String[] {
				Long.class.getName(), Integer.class.getName(),
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_P_NOTS = new FinderPath(LayoutRevisionModelImpl.ENTITY_CACHE_ENABLED,
			LayoutRevisionModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_COUNT, "countByP_NotS",
			new String[] { Long.class.getName(), Integer.class.getName() },
			LayoutRevisionModelImpl.PLID_COLUMN_BITMASK |
			LayoutRevisionModelImpl.STATUS_COLUMN_BITMASK);
	...
	public List<LayoutRevision> findByP_NotS(long plid, int status, int start,
		...
		List<LayoutRevision> list = (List<LayoutRevision>)FinderCacheUtil.getResult(FINDER_PATH_FIND_BY_P_NOTS,
				finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_FIND_BY_P_NOTS,
					finderArgs, list);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_P_NOTS,
					finderArgs);
	...
	public int countByP_NotS(long plid, int status) throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_P_NOTS,
					finderArgs);
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_L_L_P = new FinderPath(LayoutRevisionModelImpl.ENTITY_CACHE_ENABLED,
			LayoutRevisionModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_COUNT, "countByL_L_P",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName()
			},
			LayoutRevisionModelImpl.LAYOUTSETBRANCHID_COLUMN_BITMASK |
	...
	public int countByL_L_P(long layoutSetBranchId, long layoutBranchId,
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_L_L_P,
					finderArgs);
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_L_P_P = new FinderPath(LayoutRevisionModelImpl.ENTITY_CACHE_ENABLED,
			LayoutRevisionModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_COUNT, "countByL_P_P",
			new String[] {
				Long.class.getName(), Long.class.getName(), Long.class.getName()
			},
			LayoutRevisionModelImpl.LAYOUTSETBRANCHID_COLUMN_BITMASK |
	...
	public int countByL_P_P(long layoutSetBranchId,
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_L_P_P,
					finderArgs);
	...
	public static final FinderPath FINDER_PATH_FIND_BY_L_H_P = new FinderPath(LayoutRevisionModelImpl.ENTITY_CACHE_ENABLED,
			LayoutRevisionModelImpl.FINDER_CACHE_ENABLED,
			LayoutRevisionImpl.class, FINDER_CLASS_NAME_LIST, "findByL_H_P",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Long.class.getName(),
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_L_H_P = new FinderPath(LayoutRevisionModelImpl.ENTITY_CACHE_ENABLED,
			LayoutRevisionModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_COUNT, "countByL_H_P",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				Long.class.getName()
			},
	...
	protected List<LayoutRevision> findByL_H_P(long layoutSetBranchId,
		...
		List<LayoutRevision> list = (List<LayoutRevision>)FinderCacheUtil.getResult(FINDER_PATH_FIND_BY_L_H_P,
				finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				FinderCacheUtil.putResult(FINDER_PATH_FIND_BY_L_H_P,
					finderArgs, list);
			}
			catch (Exception e) {
				FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_L_H_P,
					finderArgs);
	...
	public int countByL_H_P(long layoutSetBranchId, boolean head, long plid)
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_L_H_P,
					finderArgs);
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_L_P_S = new FinderPath(LayoutRevisionModelImpl.ENTITY_CACHE_ENABLED,
			LayoutRevisionModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_COUNT, "countByL_P_S",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				Integer.class.getName()
			},
	...
	public int countByL_P_S(long layoutSetBranchId, long plid, int status)
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_L_P_S,
					finderArgs);
