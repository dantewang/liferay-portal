		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					...
					FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_L_H,
						finderArgs, count);
				}
		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					...
					FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_L_P,
						finderArgs, count);
				}
		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					...
					FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_L_S,
						finderArgs, count);
				}
	...
	public List<LayoutRevision> findByH_P(boolean head, long plid, int start,
		...
		if (list == null) {
			...
			try {
				...
				if (list == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_H_P,
						finderArgs);
				}
				else {
					cacheResult(list);

					FinderCacheUtil.putResult(FINDER_PATH_FIND_BY_H_P,
						finderArgs, list);
				}
		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					...
					FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_H_P,
						finderArgs, count);
				}
