...
public class ShardPersistenceImpl extends BasePersistenceImpl<Shard>
	...
	protected List<Shard> findByName(String name, int start, int end,
		...
		List<Shard> list = (List<Shard>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_NAME,
				finderArgs, this);
	...
	protected List<Shard> findByC_C(long classNameId, long classPK, int start,
		...
		List<Shard> list = (List<Shard>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_C_C,
				finderArgs, this);
	...
	public List<Shard> findAll(int start, int end,
		...
		List<Shard> list = (List<Shard>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_ALL,
				finderArgs, this);
