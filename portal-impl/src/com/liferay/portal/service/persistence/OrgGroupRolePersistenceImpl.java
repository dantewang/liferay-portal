...
public class OrgGroupRolePersistenceImpl extends BasePersistenceImpl<OrgGroupRole>
	...
	public List<OrgGroupRole> findByGroupId(long groupId, int start, int end,
		...
		List<OrgGroupRole> list = (List<OrgGroupRole>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUPID,
				finderArgs, this);
	...
	public List<OrgGroupRole> findByRoleId(long roleId, int start, int end,
		...
		List<OrgGroupRole> list = (List<OrgGroupRole>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_ROLEID,
				finderArgs, this);
	...
	public List<OrgGroupRole> findAll(int start, int end,
		...
		List<OrgGroupRole> list = (List<OrgGroupRole>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_ALL,
				finderArgs, this);
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sql = _SQL_SELECT_ORGGROUPROLE.concat(OrgGroupRoleModelImpl.ORDER_BY_JPQL);
			}
