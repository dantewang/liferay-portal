...
public class AddressPersistenceImpl extends BasePersistenceImpl<Address>
	...
	public List<Address> findByCompanyId(long companyId, int start, int end,
		...
		List<Address> list = (List<Address>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_COMPANYID,
				finderArgs, this);
	...
	public List<Address> findByUserId(long userId, int start, int end,
		...
		List<Address> list = (List<Address>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_USERID,
				finderArgs, this);
	...
	public List<Address> findByC_C(long companyId, long classNameId, int start,
		...
		List<Address> list = (List<Address>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_C_C,
				finderArgs, this);
	...
	public List<Address> findByC_C_C(long companyId, long classNameId,
		...
		List<Address> list = (List<Address>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_C_C_C,
				finderArgs, this);
	...
	public List<Address> findByC_C_C_M(long companyId, long classNameId,
		...
		List<Address> list = (List<Address>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_C_C_C_M,
				finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				if (list == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_C_C_C_M,
						finderArgs);
				}
				else {
					cacheResult(list);

					FinderCacheUtil.putResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_C_C_C_M,
						finderArgs, list);
				}
	...
	public List<Address> findByC_C_C_P(long companyId, long classNameId,
		...
		List<Address> list = (List<Address>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_C_C_C_P,
				finderArgs, this);
	...
	public List<Address> findAll(int start, int end,
		...
		List<Address> list = (List<Address>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_ALL,
				finderArgs, this);
