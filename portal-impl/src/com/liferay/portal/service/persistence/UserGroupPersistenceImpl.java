...
public class UserGroupPersistenceImpl extends BasePersistenceImpl<UserGroup>
	...
	public List<UserGroup> findByCompanyId(long companyId, int start, int end,
		...
		List<UserGroup> list = (List<UserGroup>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_COMPANYID,
				finderArgs, this);
	...
	public List<UserGroup> findByC_P(long companyId, long parentUserGroupId,
		...
		List<UserGroup> list = (List<UserGroup>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_C_P,
				finderArgs, this);
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_C_N = new FinderPath(UserGroupModelImpl.ENTITY_CACHE_ENABLED,
			UserGroupModelImpl.FINDER_CACHE_ENABLED, UserGroupImpl.class,
	...
	public List<UserGroup> findAll(int start, int end,
		...
		List<UserGroup> list = (List<UserGroup>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_ALL,
				finderArgs, this);
