...
public class PhonePersistenceImpl extends BasePersistenceImpl<Phone>
	...
	public List<Phone> findByCompanyId(long companyId, int start, int end,
		...
		List<Phone> list = (List<Phone>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_COMPANYID,
				finderArgs, this);
	...
	public List<Phone> findByUserId(long userId, int start, int end,
		...
		List<Phone> list = (List<Phone>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_USERID,
				finderArgs, this);
	...
	public List<Phone> findByC_C(long companyId, long classNameId, int start,
		...
		List<Phone> list = (List<Phone>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_C_C,
				finderArgs, this);
	...
	public List<Phone> findByC_C_C(long companyId, long classNameId,
		...
		List<Phone> list = (List<Phone>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_C_C_C,
				finderArgs, this);
	...
	public List<Phone> findByC_C_C_P(long companyId, long classNameId,
		...
		List<Phone> list = (List<Phone>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_C_C_C_P,
				finderArgs, this);
	...
	public List<Phone> findAll(int start, int end,
		...
		List<Phone> list = (List<Phone>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_ALL,
				finderArgs, this);
