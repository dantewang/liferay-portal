	...
	public int countByC_N(long companyId, String name)
		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_C_N,
						finderArgs);
				}
				else {
					FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_C_N,
						finderArgs, count);
				}
	...
	public int countByC_F(long companyId, String friendlyURL)
		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_C_F,
						finderArgs);
				}
				else {
					FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_C_F,
						finderArgs, count);
				}
	...
	public int countByT_A(int type, boolean active) throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_T_A,
						finderArgs);
				}
				else {
					FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_T_A,
						finderArgs, count);
				}
	...
	public int countByC_C_C(long companyId, long classNameId, long classPK)
		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_C_C_C,
						finderArgs);
				}
				else {
	...
	public int countByC_P_S(long companyId, long parentGroupId, boolean site)
		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_C_P_S,
						finderArgs);
				}
				else {
	...
	public int countByC_L_N(long companyId, long liveGroupId, String name)
		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_C_L_N,
						finderArgs);
				}
				else {
	...
	public int countByC_C_L_N(long companyId, long classNameId,
		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_C_C_L_N,
						finderArgs);
				}
				else {
