...
public class ResourceBlockPersistenceImpl extends BasePersistenceImpl<ResourceBlock>
	...
	public List<ResourceBlock> findByC_N(long companyId, String name,
		...
		List<ResourceBlock> list = (List<ResourceBlock>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_C_N,
				finderArgs, this);
	...
	public List<ResourceBlock> findByC_G_N(long companyId, long groupId,
		...
		List<ResourceBlock> list = (List<ResourceBlock>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_C_G_N,
				finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				if (list == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_C_G_N,
						finderArgs);
				}
				else {
					cacheResult(list);

					FinderCacheUtil.putResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_C_G_N,
						finderArgs, list);
				}
	...
	public List<ResourceBlock> findAll(int start, int end,
		...
		List<ResourceBlock> list = (List<ResourceBlock>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_ALL,
				finderArgs, this);
