...
public abstract class SubscriptionLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(subscriptionLocalService);
		actionableDSLQuery.setTable(SubscriptionTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("subscriptionId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(Subscription.class);

		indexableActionableDSLQuery.setBaseLocalService(
			subscriptionLocalService);
		indexableActionableDSLQuery.setTable(SubscriptionTable.INSTANCE);

		indexableActionableDSLQuery.setPrimaryKeyPropertyName("subscriptionId");
