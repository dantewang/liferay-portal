...
public abstract class CountryLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(countryLocalService);
		actionableDSLQuery.setTable(CountryTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("countryId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(Country.class);

		indexableActionableDSLQuery.setBaseLocalService(countryLocalService);
		indexableActionableDSLQuery.setTable(CountryTable.INSTANCE);

		indexableActionableDSLQuery.setPrimaryKeyPropertyName("countryId");
	...
	public ExportActionableDSLQuery getExportActionableDSLQuery(
		...
		exportActionableDSLQuery.buildDSL(
			dslBuilder -> {
				...
				predicate = portletDataContext.getDateRangePredicate(
					CountryTable.INSTANCE.modifiedDate);
		...
		exportActionableDSLQuery.setPerformActionMethod(
			new ActionableDSLQuery.PerformActionMethod<Country>() {
