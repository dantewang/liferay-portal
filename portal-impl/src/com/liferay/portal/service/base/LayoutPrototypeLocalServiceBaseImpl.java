...
public abstract class LayoutPrototypeLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(layoutPrototypeLocalService);
		actionableDSLQuery.setTable(LayoutPrototypeTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("layoutPrototypeId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(LayoutPrototype.class);

		indexableActionableDSLQuery.setBaseLocalService(
			layoutPrototypeLocalService);
		indexableActionableDSLQuery.setTable(LayoutPrototypeTable.INSTANCE);
	...
	public ExportActionableDSLQuery getExportActionableDSLQuery(
		...
		exportActionableDSLQuery.setPerformActionMethod(
			new ActionableDSLQuery.PerformActionMethod<LayoutPrototype>() {
