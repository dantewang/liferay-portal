...
public abstract class ResourcePermissionLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(resourcePermissionLocalService);
		actionableDSLQuery.setTable(ResourcePermissionTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("resourcePermissionId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(ResourcePermission.class);

		indexableActionableDSLQuery.setBaseLocalService(
			resourcePermissionLocalService);
		indexableActionableDSLQuery.setTable(ResourcePermissionTable.INSTANCE);
