...
public abstract class PortalPreferencesLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(portalPreferencesLocalService);
		actionableDSLQuery.setTable(PortalPreferencesTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("portalPreferencesId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(PortalPreferences.class);

		indexableActionableDSLQuery.setBaseLocalService(
			portalPreferencesLocalService);
		indexableActionableDSLQuery.setTable(PortalPreferencesTable.INSTANCE);
