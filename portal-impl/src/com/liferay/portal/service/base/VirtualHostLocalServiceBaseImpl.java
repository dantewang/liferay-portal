...
public abstract class VirtualHostLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(virtualHostLocalService);
		actionableDSLQuery.setTable(VirtualHostTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("virtualHostId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(VirtualHost.class);

		indexableActionableDSLQuery.setBaseLocalService(
			virtualHostLocalService);
		indexableActionableDSLQuery.setTable(VirtualHostTable.INSTANCE);

		indexableActionableDSLQuery.setPrimaryKeyPropertyName("virtualHostId");
