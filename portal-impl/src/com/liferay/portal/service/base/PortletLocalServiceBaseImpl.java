...
public abstract class PortletLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(portletLocalService);
		actionableDSLQuery.setTable(PortletTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("id");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(Portlet.class);

		indexableActionableDSLQuery.setBaseLocalService(portletLocalService);
		indexableActionableDSLQuery.setTable(PortletTable.INSTANCE);

		indexableActionableDSLQuery.setPrimaryKeyPropertyName("id");
