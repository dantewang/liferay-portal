...
public abstract class RecentLayoutRevisionLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(
			recentLayoutRevisionLocalService);
		actionableDSLQuery.setTable(RecentLayoutRevisionTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("recentLayoutRevisionId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(RecentLayoutRevision.class);
