...
public abstract class OrganizationLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(organizationLocalService);
		actionableDSLQuery.setTable(OrganizationTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("organizationId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(Organization.class);

		indexableActionableDSLQuery.setBaseLocalService(
			organizationLocalService);
		indexableActionableDSLQuery.setTable(OrganizationTable.INSTANCE);

		indexableActionableDSLQuery.setPrimaryKeyPropertyName("organizationId");
	...
	public ExportActionableDSLQuery getExportActionableDSLQuery(
		...
		exportActionableDSLQuery.setPerformActionMethod(
			new ActionableDSLQuery.PerformActionMethod<Organization>() {
