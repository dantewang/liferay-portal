...
public abstract class MembershipRequestLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(membershipRequestLocalService);
		actionableDSLQuery.setTable(MembershipRequestTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("membershipRequestId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(MembershipRequest.class);

		indexableActionableDSLQuery.setBaseLocalService(
			membershipRequestLocalService);
		indexableActionableDSLQuery.setTable(MembershipRequestTable.INSTANCE);
