...
public abstract class TeamLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(teamLocalService);
		actionableDSLQuery.setTable(TeamTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("teamId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(Team.class);

		indexableActionableDSLQuery.setBaseLocalService(teamLocalService);
		indexableActionableDSLQuery.setTable(TeamTable.INSTANCE);

		indexableActionableDSLQuery.setPrimaryKeyPropertyName("teamId");
	...
	public ExportActionableDSLQuery getExportActionableDSLQuery(
		...
		exportActionableDSLQuery.setPerformActionMethod(
			new ActionableDSLQuery.PerformActionMethod<Team>() {
