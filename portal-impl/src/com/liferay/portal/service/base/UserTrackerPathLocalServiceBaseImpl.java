...
public abstract class UserTrackerPathLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(userTrackerPathLocalService);
		actionableDSLQuery.setTable(UserTrackerPathTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("userTrackerPathId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(UserTrackerPath.class);

		indexableActionableDSLQuery.setBaseLocalService(
			userTrackerPathLocalService);
		indexableActionableDSLQuery.setTable(UserTrackerPathTable.INSTANCE);
