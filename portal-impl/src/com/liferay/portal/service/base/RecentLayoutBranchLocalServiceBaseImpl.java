...
public abstract class RecentLayoutBranchLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(recentLayoutBranchLocalService);
		actionableDSLQuery.setTable(RecentLayoutBranchTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("recentLayoutBranchId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(RecentLayoutBranch.class);

		indexableActionableDSLQuery.setBaseLocalService(
			recentLayoutBranchLocalService);
		indexableActionableDSLQuery.setTable(RecentLayoutBranchTable.INSTANCE);
