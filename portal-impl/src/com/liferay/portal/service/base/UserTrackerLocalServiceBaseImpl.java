...
public abstract class UserTrackerLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(userTrackerLocalService);
		actionableDSLQuery.setTable(UserTrackerTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("userTrackerId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(UserTracker.class);

		indexableActionableDSLQuery.setBaseLocalService(
			userTrackerLocalService);
		indexableActionableDSLQuery.setTable(UserTrackerTable.INSTANCE);

		indexableActionableDSLQuery.setPrimaryKeyPropertyName("userTrackerId");
