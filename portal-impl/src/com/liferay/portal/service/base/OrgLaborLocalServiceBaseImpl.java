...
public abstract class OrgLaborLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(orgLaborLocalService);
		actionableDSLQuery.setTable(OrgLaborTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("orgLaborId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(OrgLabor.class);

		indexableActionableDSLQuery.setBaseLocalService(orgLaborLocalService);
		indexableActionableDSLQuery.setTable(OrgLaborTable.INSTANCE);

		indexableActionableDSLQuery.setPrimaryKeyPropertyName("orgLaborId");
