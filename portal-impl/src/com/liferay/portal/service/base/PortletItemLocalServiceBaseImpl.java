...
public abstract class PortletItemLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(portletItemLocalService);
		actionableDSLQuery.setTable(PortletItemTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("portletItemId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(PortletItem.class);

		indexableActionableDSLQuery.setBaseLocalService(
			portletItemLocalService);
		indexableActionableDSLQuery.setTable(PortletItemTable.INSTANCE);

		indexableActionableDSLQuery.setPrimaryKeyPropertyName("portletItemId");
