...
public abstract class UserGroupGroupRoleLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(userGroupGroupRoleLocalService);
		actionableDSLQuery.setTable(UserGroupGroupRoleTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("userGroupGroupRoleId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(UserGroupGroupRole.class);

		indexableActionableDSLQuery.setBaseLocalService(
			userGroupGroupRoleLocalService);
		indexableActionableDSLQuery.setTable(UserGroupGroupRoleTable.INSTANCE);
