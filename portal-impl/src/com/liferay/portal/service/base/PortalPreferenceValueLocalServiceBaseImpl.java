...
public abstract class PortalPreferenceValueLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(
			portalPreferenceValueLocalService);
		actionableDSLQuery.setTable(PortalPreferenceValueTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("portalPreferenceValueId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(PortalPreferenceValue.class);
