...
public abstract class LayoutSetPrototypeLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(layoutSetPrototypeLocalService);
		actionableDSLQuery.setTable(LayoutSetPrototypeTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("layoutSetPrototypeId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(LayoutSetPrototype.class);

		indexableActionableDSLQuery.setBaseLocalService(
			layoutSetPrototypeLocalService);
		indexableActionableDSLQuery.setTable(LayoutSetPrototypeTable.INSTANCE);
	...
	public ExportActionableDSLQuery getExportActionableDSLQuery(
		...
		exportActionableDSLQuery.buildDSL(
			dslBuilder -> {
				...
				predicate = portletDataContext.getDateRangePredicate(
					LayoutSetPrototypeTable.INSTANCE.modifiedDate);
		...
		exportActionableDSLQuery.setPerformActionMethod(
			new ActionableDSLQuery.PerformActionMethod<LayoutSetPrototype>() {
