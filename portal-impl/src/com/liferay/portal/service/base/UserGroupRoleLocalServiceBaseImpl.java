...
public abstract class UserGroupRoleLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(userGroupRoleLocalService);
		actionableDSLQuery.setTable(UserGroupRoleTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("userGroupRoleId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(UserGroupRole.class);

		indexableActionableDSLQuery.setBaseLocalService(
			userGroupRoleLocalService);
		indexableActionableDSLQuery.setTable(UserGroupRoleTable.INSTANCE);
