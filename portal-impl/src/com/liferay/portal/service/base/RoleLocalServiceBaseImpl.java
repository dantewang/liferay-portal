...
public abstract class RoleLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(roleLocalService);
		actionableDSLQuery.setTable(RoleTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("roleId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(Role.class);

		indexableActionableDSLQuery.setBaseLocalService(roleLocalService);
		indexableActionableDSLQuery.setTable(RoleTable.INSTANCE);

		indexableActionableDSLQuery.setPrimaryKeyPropertyName("roleId");
	...
	public ExportActionableDSLQuery getExportActionableDSLQuery(
			...
			dslBuilder -> {
				...
				if ((referrerClassNameId !=
					...
					predicate = Predicate.and(
						predicate,
						RoleTable.INSTANCE.classNameId.eq(referrerClassNameId));
				}
				else if (referrerClassNameId ==
							StagedModelType.REFERRER_CLASS_NAME_ID_ANY) {

					predicate = Predicate.and(
						predicate, RoleTable.INSTANCE.classNameId.isNotNull());
				}
		...
		exportActionableDSLQuery.setPerformActionMethod(
			new ActionableDSLQuery.PerformActionMethod<Role>() {
