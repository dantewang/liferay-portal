...
public abstract class ImageLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(imageLocalService);
		actionableDSLQuery.setTable(ImageTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("imageId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(Image.class);

		indexableActionableDSLQuery.setBaseLocalService(imageLocalService);
		indexableActionableDSLQuery.setTable(ImageTable.INSTANCE);

		indexableActionableDSLQuery.setPrimaryKeyPropertyName("imageId");
