...
public abstract class UserLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(userLocalService);
		actionableDSLQuery.setTable(UserTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("userId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(User.class);

		indexableActionableDSLQuery.setBaseLocalService(userLocalService);
		indexableActionableDSLQuery.setTable(UserTable.INSTANCE);

		indexableActionableDSLQuery.setPrimaryKeyPropertyName("userId");
	...
	public ExportActionableDSLQuery getExportActionableDSLQuery(
		...
		exportActionableDSLQuery.setPerformActionMethod(
			new ActionableDSLQuery.PerformActionMethod<User>() {
