...
public abstract class LayoutSetLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(layoutSetLocalService);
		actionableDSLQuery.setTable(LayoutSetTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("layoutSetId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(LayoutSet.class);

		indexableActionableDSLQuery.setBaseLocalService(layoutSetLocalService);
		indexableActionableDSLQuery.setTable(LayoutSetTable.INSTANCE);

		indexableActionableDSLQuery.setPrimaryKeyPropertyName("layoutSetId");
