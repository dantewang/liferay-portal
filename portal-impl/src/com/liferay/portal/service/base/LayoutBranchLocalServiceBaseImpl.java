...
public abstract class LayoutBranchLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(layoutBranchLocalService);
		actionableDSLQuery.setTable(LayoutBranchTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("layoutBranchId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(LayoutBranch.class);

		indexableActionableDSLQuery.setBaseLocalService(
			layoutBranchLocalService);
		indexableActionableDSLQuery.setTable(LayoutBranchTable.INSTANCE);

		indexableActionableDSLQuery.setPrimaryKeyPropertyName("layoutBranchId");
