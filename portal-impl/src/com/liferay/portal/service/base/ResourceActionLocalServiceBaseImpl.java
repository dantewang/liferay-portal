...
public abstract class ResourceActionLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(resourceActionLocalService);
		actionableDSLQuery.setTable(ResourceActionTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("resourceActionId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(ResourceAction.class);

		indexableActionableDSLQuery.setBaseLocalService(
			resourceActionLocalService);
		indexableActionableDSLQuery.setTable(ResourceActionTable.INSTANCE);
