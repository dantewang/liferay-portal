...
public abstract class WebDAVPropsLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(webDAVPropsLocalService);
		actionableDSLQuery.setTable(WebDAVPropsTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("webDavPropsId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(WebDAVProps.class);

		indexableActionableDSLQuery.setBaseLocalService(
			webDAVPropsLocalService);
		indexableActionableDSLQuery.setTable(WebDAVPropsTable.INSTANCE);

		indexableActionableDSLQuery.setPrimaryKeyPropertyName("webDavPropsId");
