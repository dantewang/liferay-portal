...
public abstract class GroupLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(groupLocalService);
		actionableDSLQuery.setTable(GroupTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("groupId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(Group.class);

		indexableActionableDSLQuery.setBaseLocalService(groupLocalService);
		indexableActionableDSLQuery.setTable(GroupTable.INSTANCE);

		indexableActionableDSLQuery.setPrimaryKeyPropertyName("groupId");
