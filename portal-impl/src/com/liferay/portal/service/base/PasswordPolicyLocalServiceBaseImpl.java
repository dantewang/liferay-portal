...
public abstract class PasswordPolicyLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(passwordPolicyLocalService);
		actionableDSLQuery.setTable(PasswordPolicyTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("passwordPolicyId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(PasswordPolicy.class);

		indexableActionableDSLQuery.setBaseLocalService(
			passwordPolicyLocalService);
		indexableActionableDSLQuery.setTable(PasswordPolicyTable.INSTANCE);
	...
	public ExportActionableDSLQuery getExportActionableDSLQuery(
		...
		exportActionableDSLQuery.buildDSL(
			dslBuilder -> {
				...
				predicate = portletDataContext.getDateRangePredicate(
					PasswordPolicyTable.INSTANCE.modifiedDate);
		...
		exportActionableDSLQuery.setPerformActionMethod(
			new ActionableDSLQuery.PerformActionMethod<PasswordPolicy>() {
