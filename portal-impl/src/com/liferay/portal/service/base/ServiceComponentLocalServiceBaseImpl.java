...
public abstract class ServiceComponentLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(serviceComponentLocalService);
		actionableDSLQuery.setTable(ServiceComponentTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("serviceComponentId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(ServiceComponent.class);

		indexableActionableDSLQuery.setBaseLocalService(
			serviceComponentLocalService);
		indexableActionableDSLQuery.setTable(ServiceComponentTable.INSTANCE);
