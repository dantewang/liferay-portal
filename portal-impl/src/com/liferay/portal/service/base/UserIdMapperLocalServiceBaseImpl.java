...
public abstract class UserIdMapperLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(userIdMapperLocalService);
		actionableDSLQuery.setTable(UserIdMapperTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("userIdMapperId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(UserIdMapper.class);

		indexableActionableDSLQuery.setBaseLocalService(
			userIdMapperLocalService);
		indexableActionableDSLQuery.setTable(UserIdMapperTable.INSTANCE);

		indexableActionableDSLQuery.setPrimaryKeyPropertyName("userIdMapperId");
