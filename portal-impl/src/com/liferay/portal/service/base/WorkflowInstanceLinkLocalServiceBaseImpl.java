...
public abstract class WorkflowInstanceLinkLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(
			workflowInstanceLinkLocalService);
		actionableDSLQuery.setTable(WorkflowInstanceLinkTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("workflowInstanceLinkId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(WorkflowInstanceLink.class);
