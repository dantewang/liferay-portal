...
public abstract class RepositoryEntryLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(repositoryEntryLocalService);
		actionableDSLQuery.setTable(RepositoryEntryTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("repositoryEntryId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(RepositoryEntry.class);

		indexableActionableDSLQuery.setBaseLocalService(
			repositoryEntryLocalService);
		indexableActionableDSLQuery.setTable(RepositoryEntryTable.INSTANCE);
	...
	public ExportActionableDSLQuery getExportActionableDSLQuery(
		...
		exportActionableDSLQuery.buildDSL(
			dslBuilder -> {
				...
				predicate = portletDataContext.getDateRangePredicate(
					RepositoryEntryTable.INSTANCE.modifiedDate);
		...
		exportActionableDSLQuery.setPerformActionMethod(
			new ActionableDSLQuery.PerformActionMethod<RepositoryEntry>() {
