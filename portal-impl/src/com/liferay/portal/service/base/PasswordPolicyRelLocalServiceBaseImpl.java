...
public abstract class PasswordPolicyRelLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(passwordPolicyRelLocalService);
		actionableDSLQuery.setTable(PasswordPolicyRelTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("passwordPolicyRelId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(PasswordPolicyRel.class);

		indexableActionableDSLQuery.setBaseLocalService(
			passwordPolicyRelLocalService);
		indexableActionableDSLQuery.setTable(PasswordPolicyRelTable.INSTANCE);
