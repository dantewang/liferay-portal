...
public abstract class PortletPreferencesLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(portletPreferencesLocalService);
		actionableDSLQuery.setTable(PortletPreferencesTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("portletPreferencesId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(PortletPreferences.class);

		indexableActionableDSLQuery.setBaseLocalService(
			portletPreferencesLocalService);
		indexableActionableDSLQuery.setTable(PortletPreferencesTable.INSTANCE);
