...
public abstract class SystemEventLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(systemEventLocalService);
		actionableDSLQuery.setTable(SystemEventTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("systemEventId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(SystemEvent.class);

		indexableActionableDSLQuery.setBaseLocalService(
			systemEventLocalService);
		indexableActionableDSLQuery.setTable(SystemEventTable.INSTANCE);

		indexableActionableDSLQuery.setPrimaryKeyPropertyName("systemEventId");
