...
public abstract class PluginSettingLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(pluginSettingLocalService);
		actionableDSLQuery.setTable(PluginSettingTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("pluginSettingId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(PluginSetting.class);

		indexableActionableDSLQuery.setBaseLocalService(
			pluginSettingLocalService);
		indexableActionableDSLQuery.setTable(PluginSettingTable.INSTANCE);
