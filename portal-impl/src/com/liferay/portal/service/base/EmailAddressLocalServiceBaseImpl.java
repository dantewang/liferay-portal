...
public abstract class EmailAddressLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(emailAddressLocalService);
		actionableDSLQuery.setTable(EmailAddressTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("emailAddressId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(EmailAddress.class);

		indexableActionableDSLQuery.setBaseLocalService(
			emailAddressLocalService);
		indexableActionableDSLQuery.setTable(EmailAddressTable.INSTANCE);

		indexableActionableDSLQuery.setPrimaryKeyPropertyName("emailAddressId");
	...
	public ExportActionableDSLQuery getExportActionableDSLQuery(
		...
		exportActionableDSLQuery.buildDSL(
			dslBuilder -> {
				...
				predicate = portletDataContext.getDateRangePredicate(
					EmailAddressTable.INSTANCE.modifiedDate);
				...
				if ((referrerClassNameId !=
					...
					predicate = Predicate.and(
						predicate,
						EmailAddressTable.INSTANCE.classNameId.eq(
							referrerClassNameId));
				}
				else if (referrerClassNameId ==
							StagedModelType.REFERRER_CLASS_NAME_ID_ANY) {
					...
					predicate = Predicate.and(
						predicate,
						EmailAddressTable.INSTANCE.classNameId.isNotNull());
				}
		...
		exportActionableDSLQuery.setPerformActionMethod(
			new ActionableDSLQuery.PerformActionMethod<EmailAddress>() {
