...
public abstract class RegionLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(regionLocalService);
		actionableDSLQuery.setTable(RegionTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("regionId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(Region.class);

		indexableActionableDSLQuery.setBaseLocalService(regionLocalService);
		indexableActionableDSLQuery.setTable(RegionTable.INSTANCE);

		indexableActionableDSLQuery.setPrimaryKeyPropertyName("regionId");
	...
	public ExportActionableDSLQuery getExportActionableDSLQuery(
		...
		exportActionableDSLQuery.buildDSL(
			dslBuilder -> {
				...
				predicate = portletDataContext.getDateRangePredicate(
					RegionTable.INSTANCE.modifiedDate);
		...
		exportActionableDSLQuery.setPerformActionMethod(
			new ActionableDSLQuery.PerformActionMethod<Region>() {
