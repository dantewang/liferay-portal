...
public abstract class RepositoryLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(repositoryLocalService);
		actionableDSLQuery.setTable(RepositoryTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("repositoryId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(Repository.class);

		indexableActionableDSLQuery.setBaseLocalService(repositoryLocalService);
		indexableActionableDSLQuery.setTable(RepositoryTable.INSTANCE);

		indexableActionableDSLQuery.setPrimaryKeyPropertyName("repositoryId");
	...
	public ExportActionableDSLQuery getExportActionableDSLQuery(
			...
			dslBuilder -> {
				...
				if ((referrerClassNameId !=
					...
					predicate = Predicate.and(
						predicate,
						RepositoryTable.INSTANCE.classNameId.eq(
							referrerClassNameId));
				}
				else if (referrerClassNameId ==
							StagedModelType.REFERRER_CLASS_NAME_ID_ANY) {
					...
					predicate = Predicate.and(
						predicate,
						RepositoryTable.INSTANCE.classNameId.isNotNull());
				}
		...
		exportActionableDSLQuery.setPerformActionMethod(
			new ActionableDSLQuery.PerformActionMethod<Repository>() {
