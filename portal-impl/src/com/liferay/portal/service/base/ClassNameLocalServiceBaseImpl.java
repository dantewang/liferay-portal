...
public abstract class ClassNameLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(classNameLocalService);
		actionableDSLQuery.setTable(ClassNameTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("classNameId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(ClassName.class);

		indexableActionableDSLQuery.setBaseLocalService(classNameLocalService);
		indexableActionableDSLQuery.setTable(ClassNameTable.INSTANCE);

		indexableActionableDSLQuery.setPrimaryKeyPropertyName("classNameId");
