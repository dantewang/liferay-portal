...
public abstract class ReleaseLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(releaseLocalService);
		actionableDSLQuery.setTable(ReleaseTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("releaseId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(Release.class);

		indexableActionableDSLQuery.setBaseLocalService(releaseLocalService);
		indexableActionableDSLQuery.setTable(ReleaseTable.INSTANCE);

		indexableActionableDSLQuery.setPrimaryKeyPropertyName("releaseId");
