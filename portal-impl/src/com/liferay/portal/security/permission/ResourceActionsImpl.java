...
public class ResourceActionsImpl implements ResourceActions {
	...
	public void readAndCheck(ClassLoader classLoader, String... sources)
		...
		for (String source : sources) {
			_read(classLoader, source, resourceNames);
		}
	...
	private void _read(
			ClassLoader classLoader, String source, Set<String> resourceNames)
		throws ResourceActionsException {
		...
		try {
			...
			for (Element resourceElement : rootElement.elements("resource")) {
				...
				_read(classLoader, file, resourceNames);

				String extFileName = StringUtil.replace(
					file, ".xml", "-ext.xml");

				_read(classLoader, extFileName, resourceNames);
			}
	...
	private void _read(Document document, Set<String> resourceNames)
		throws ResourceActionsException {
