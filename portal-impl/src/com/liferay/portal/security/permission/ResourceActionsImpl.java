...
public class ResourceActionsImpl implements ResourceActions {
	...
	/**
	 * @deprecated As of Athanasius (7.3.x), replaced by {@link
	 *             #readPortletResource(String, Document)} and
	 *             {@link #readModelResource(String, Document)}
	 */
	@Deprecated
	@Override
	public void read(
		...
		_readModelResource(servletContextName, rootElement, resourceNames);
	}
	...
	public void readPortletResource(
		...
		_readPortletResource(
			null, servletContextName, document.getRootElement(), null);
	}
