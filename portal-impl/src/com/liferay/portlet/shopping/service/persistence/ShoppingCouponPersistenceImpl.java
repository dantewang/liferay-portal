...
public class ShoppingCouponPersistenceImpl extends BasePersistenceImpl<ShoppingCoupon>
	...
	public List<ShoppingCoupon> findByGroupId(long groupId, int start, int end,
		...
		List<ShoppingCoupon> list = (List<ShoppingCoupon>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUPID,
				finderArgs, this);
	...
	public List<ShoppingCoupon> findAll(int start, int end,
		...
		List<ShoppingCoupon> list = (List<ShoppingCoupon>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_ALL,
				finderArgs, this);
