...
public class ShoppingCategoryPersistenceImpl extends BasePersistenceImpl<ShoppingCategory>
	...
	public List<ShoppingCategory> findByGroupId(long groupId, int start,
		...
		List<ShoppingCategory> list = (List<ShoppingCategory>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUPID,
				finderArgs, this);
	...
	public List<ShoppingCategory> findByG_P(long groupId,
		...
		List<ShoppingCategory> list = (List<ShoppingCategory>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_G_P,
				finderArgs, this);
	...
	public List<ShoppingCategory> findAll(int start, int end,
		...
		List<ShoppingCategory> list = (List<ShoppingCategory>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_ALL,
				finderArgs, this);
