...
public class AssetUtil {
	...
	public static ObjectValuePair<Integer, List<AssetEntry>> search(
		...
		Set<String> selectedFieldNames = new HashSet<String>(2);

		selectedFieldNames.add(Field.ENTRY_CLASS_NAME);
		selectedFieldNames.add(Field.ENTRY_CLASS_PK);

		searchContext.setSelectedFieldNames(selectedFieldNames);
