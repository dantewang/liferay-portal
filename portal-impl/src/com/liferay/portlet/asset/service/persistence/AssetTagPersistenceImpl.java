...
public class AssetTagPersistenceImpl extends BasePersistenceImpl<AssetTag>
	...
	protected List<AssetTag> findByG_N(long groupId, String name, int start,
		...
		List<AssetTag> list = (List<AssetTag>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_G_N,
				finderArgs, this);
	...
	public List<AssetTag> findAll(int start, int end,
		...
		List<AssetTag> list = (List<AssetTag>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_ALL,
				finderArgs, this);
