		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					...
					FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_G_V,
						finderArgs, count);
				}
		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					...
					FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_P_V,
						finderArgs, count);
				}
		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					...
					FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_N_V,
						finderArgs, count);
				}
