...
public class SCLicensePersistenceImpl extends BasePersistenceImpl<SCLicense>
	...
	public List<SCLicense> findByActive(boolean active, int start, int end,
		...
		List<SCLicense> list = (List<SCLicense>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_ACTIVE,
				finderArgs, this);
	...
	public List<SCLicense> findByA_R(boolean active, boolean recommended,
		...
		List<SCLicense> list = (List<SCLicense>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_A_R,
				finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				if (list == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_A_R,
						finderArgs);
				}
				else {
					cacheResult(list);

					FinderCacheUtil.putResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_A_R,
						finderArgs, list);
				}
	...
	public SCLicense updateImpl(
		...
		if (isNew || !SCLicenseModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((scLicenseModelImpl.getColumnBitmask() &
					FINDER_PATH_COUNT_BY_A_R.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						Boolean.valueOf(scLicenseModelImpl.getOriginalActive()),
	...
	public List<SCLicense> findAll(int start, int end,
		...
		List<SCLicense> list = (List<SCLicense>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_ALL,
				finderArgs, this);
