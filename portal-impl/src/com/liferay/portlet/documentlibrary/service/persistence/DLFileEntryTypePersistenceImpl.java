...
public class DLFileEntryTypePersistenceImpl extends BasePersistenceImpl<DLFileEntryType>
	...
	public static final FinderPath FINDER_PATH_FIND_BY_UUID = new FinderPath(DLFileEntryTypeModelImpl.ENTITY_CACHE_ENABLED,
			DLFileEntryTypeModelImpl.FINDER_CACHE_ENABLED,
			DLFileEntryTypeImpl.class, FINDER_CLASS_NAME_LIST, "findByUuid",
			new String[] {
	...
	public List<DLFileEntryType> findByUuid(String uuid, int start, int end,
		...
		List<DLFileEntryType> list = (List<DLFileEntryType>)FinderCacheUtil.getResult(FINDER_PATH_FIND_BY_UUID,
				finderArgs, this);
	...
	/**
	 * Returns the first document library file entry type in the default ordered set defined by {@link DLFileEntryTypeModelImpl#ORDER_BY_JPQL} where uuid = &#63;.
	 *
	 * @param uuid the uuid
	...
	/**
	 * Returns the last document library file entry type in the default ordered set defined by {@link DLFileEntryTypeModelImpl#ORDER_BY_JPQL} where uuid = &#63;.
	 *
	 * @param uuid the uuid
	...
	public static final FinderPath FINDER_PATH_FIND_BY_UUID_C = new FinderPath(DLFileEntryTypeModelImpl.ENTITY_CACHE_ENABLED,
			DLFileEntryTypeModelImpl.FINDER_CACHE_ENABLED,
			DLFileEntryTypeImpl.class, FINDER_CLASS_NAME_LIST, "findByUuid_C",
			new String[] {
	...
	public List<DLFileEntryType> findByUuid_C(String uuid, long companyId,
		...
		List<DLFileEntryType> list = (List<DLFileEntryType>)FinderCacheUtil.getResult(FINDER_PATH_FIND_BY_UUID_C,
				finderArgs, this);
	...
	/**
	 * Returns the first document library file entry type in the default ordered set defined by {@link DLFileEntryTypeModelImpl#ORDER_BY_JPQL} where uuid = &#63; and companyId = &#63;.
	 *
	 * @param uuid the uuid
	 * @param companyId the company ID
	 * @return the first matching document library file entry type
	...
	/**
	 * Returns the last document library file entry type in the default ordered set defined by {@link DLFileEntryTypeModelImpl#ORDER_BY_JPQL} where uuid = &#63; and companyId = &#63;.
	 *
	 * @param uuid the uuid
	 * @param companyId the company ID
	 * @return the last matching document library file entry type
	...
	/**
	 * Returns the first document library file entry type in the default ordered set defined by {@link DLFileEntryTypeModelImpl#ORDER_BY_JPQL} where groupId = &#63;.
	 *
	 * @param groupId the group ID
	 * @return the first matching document library file entry type
	 * @throws com.liferay.portlet.documentlibrary.NoSuchFileEntryTypeException if a matching document library file entry type could not be found
	...
	/**
	 * Returns the last document library file entry type in the default ordered set defined by {@link DLFileEntryTypeModelImpl#ORDER_BY_JPQL} where groupId = &#63;.
	 *
	 * @param groupId the group ID
	 * @return the last matching document library file entry type
	 * @throws com.liferay.portlet.documentlibrary.NoSuchFileEntryTypeException if a matching document library file entry type could not be found
	...
	public List<DLFileEntryType> findAll(int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sql = _SQL_SELECT_DLFILEENTRYTYPE.concat(DLFileEntryTypeModelImpl.ORDER_BY_JPQL);
			}
		...
		if (list == null) {
			...
			try {
				...
				if (orderByComparator != null) {
					...
					sql = _SQL_GETDDMSTRUCTURES.concat(com.liferay.portlet.dynamicdatamapping.model.impl.DDMStructureModelImpl.ORDER_BY_SQL);
				}
