...
public class DLFileEntryMetadataPersistenceImpl extends BasePersistenceImpl<DLFileEntryMetadata>
	...
	public List<DLFileEntryMetadata> findByUuid(String uuid, int start,
		...
		List<DLFileEntryMetadata> list = (List<DLFileEntryMetadata>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID,
				finderArgs, this);
	...
	public List<DLFileEntryMetadata> findByFileEntryTypeId(
		...
		List<DLFileEntryMetadata> list = (List<DLFileEntryMetadata>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_FILEENTRYTYPEID,
				finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				if (list == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_FILEENTRYTYPEID,
						finderArgs);
				}
				else {
					cacheResult(list);

					FinderCacheUtil.putResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_FILEENTRYTYPEID,
						finderArgs, list);
				}
	...
	public DLFileEntryMetadata findByFileEntryTypeId_First(long fileEntryTypeId)
		throws NoSuchFileEntryMetadataException, SystemException {
		return findByFileEntryTypeId_First(fileEntryTypeId, null);
	}
	...
	public DLFileEntryMetadata fetchByFileEntryTypeId_First(
		...
		return fetchByFileEntryTypeId_First(fileEntryTypeId, null);
	}
	...
	public DLFileEntryMetadata findByFileEntryTypeId_Last(long fileEntryTypeId)
		throws NoSuchFileEntryMetadataException, SystemException {
		return findByFileEntryTypeId_Last(fileEntryTypeId, null);
	}
	...
	public DLFileEntryMetadata fetchByFileEntryTypeId_Last(long fileEntryTypeId)
		throws SystemException {
		return fetchByFileEntryTypeId_Last(fileEntryTypeId, null);
	}
	...
	public List<DLFileEntryMetadata> findByFileEntryId(long fileEntryId,
		...
		List<DLFileEntryMetadata> list = (List<DLFileEntryMetadata>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_FILEENTRYID,
				finderArgs, this);
	...
	public List<DLFileEntryMetadata> findByFileVersionId(long fileVersionId,
		...
		List<DLFileEntryMetadata> list = (List<DLFileEntryMetadata>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_FILEVERSIONID,
				finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				if (list == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_FILEVERSIONID,
						finderArgs);
				}
				else {
					cacheResult(list);

					FinderCacheUtil.putResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_FILEVERSIONID,
						finderArgs, list);
				}
	...
	public DLFileEntryMetadata findByFileVersionId_First(long fileVersionId)
		throws NoSuchFileEntryMetadataException, SystemException {
		return findByFileVersionId_First(fileVersionId, null);
	}
	...
	public DLFileEntryMetadata fetchByFileVersionId_First(long fileVersionId)
		throws SystemException {
		return fetchByFileVersionId_First(fileVersionId, null);
	}
	...
	public DLFileEntryMetadata findByFileVersionId_Last(long fileVersionId)
		throws NoSuchFileEntryMetadataException, SystemException {
		return findByFileVersionId_Last(fileVersionId, null);
	}
	...
	public DLFileEntryMetadata fetchByFileVersionId_Last(long fileVersionId)
		throws SystemException {
		return fetchByFileVersionId_Last(fileVersionId, null);
	}
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_D_F = new FinderPath(DLFileEntryMetadataModelImpl.ENTITY_CACHE_ENABLED,
			DLFileEntryMetadataModelImpl.FINDER_CACHE_ENABLED,
			DLFileEntryMetadataImpl.class,
	...
	public DLFileEntryMetadata updateImpl(
		...
		if (isNew || !DLFileEntryMetadataModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((dlFileEntryMetadataModelImpl.getColumnBitmask() &
					FINDER_PATH_COUNT_BY_FILEENTRYTYPEID.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
			...
			if ((dlFileEntryMetadataModelImpl.getColumnBitmask() &
					FINDER_PATH_COUNT_BY_FILEVERSIONID.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
	...
	public List<DLFileEntryMetadata> findAll(int start, int end,
		...
		List<DLFileEntryMetadata> list = (List<DLFileEntryMetadata>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_ALL,
				finderArgs, this);
