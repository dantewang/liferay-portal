...
public class MBCategoryPersistenceImpl extends BasePersistenceImpl<MBCategory>
	...
	public static final FinderPath FINDER_PATH_FIND_BY_UUID_C = new FinderPath(MBCategoryModelImpl.ENTITY_CACHE_ENABLED,
			MBCategoryModelImpl.FINDER_CACHE_ENABLED, MBCategoryImpl.class,
	...
	public List<MBCategory> findByUuid_C(String uuid, long companyId,
		...
		List<MBCategory> list = (List<MBCategory>)FinderCacheUtil.getResult(FINDER_PATH_FIND_BY_UUID_C,
				finderArgs, this);
