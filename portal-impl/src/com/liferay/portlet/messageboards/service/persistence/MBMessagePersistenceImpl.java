	...
	public List<MBMessage> findByU_C(long userId, long classNameId, int start,
		...
		if (list == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_U_C, finderArgs);
	...
	public List<MBMessage> findByT_P(long threadId, long parentMessageId,
		...
		if (list == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_T_P, finderArgs);
	...
	public List<MBMessage> findByT_S(long threadId, int status, int start,
		...
		if (list == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_T_S, finderArgs);
