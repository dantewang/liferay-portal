...
public class MBMessagePersistenceImpl extends BasePersistenceImpl<MBMessage>
	...
	public int countByU_C(long userId, long classNameId)
		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_U_C,
						finderArgs);
				}
				else {
					FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_U_C,
						finderArgs, count);
				}
	...
	public int countByT_P(long threadId, long parentMessageId)
		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_T_P,
						finderArgs);
				}
				else {
					FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_T_P,
						finderArgs, count);
				}
	...
	public int countByT_S(long threadId, int status) throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_T_S,
						finderArgs);
				}
				else {
					FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_T_S,
						finderArgs, count);
				}
	...
	public int countByTR_S(long threadId, int status) throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_TR_S,
						finderArgs);
				}
				else {
	...
	public int countByU_C_S(long userId, long classNameId, int status)
		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_U_C_S,
						finderArgs);
				}
				else {
	...
	public int countByC_C_S(long classNameId, long classPK, int status)
		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_C_C_S,
						finderArgs);
				}
				else {
	...
	public int countByG_C_T_A(long groupId, long categoryId, long threadId,
		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_G_C_T_A,
						finderArgs);
				}
				else {
	...
	public int countByG_C_T_S(long groupId, long categoryId, long threadId,
		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_G_C_T_S,
						finderArgs);
				}
				else {
	...
	public int countByU_C_C_S(long userId, long classNameId, long classPK,
		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_U_C_C_S,
						finderArgs);
				}
				else {
	...
	public MBMessage updateImpl(
		...
		if (isNew || !MBMessageModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((mbMessageModelImpl.getColumnBitmask() &
					FINDER_PATH_COUNT_BY_THREADREPLIES.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						Long.valueOf(mbMessageModelImpl.getOriginalThreadId())
					};
			...
			if ((mbMessageModelImpl.getColumnBitmask() &
					FINDER_PATH_COUNT_BY_U_C.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						Long.valueOf(mbMessageModelImpl.getOriginalUserId()),
			...
			if ((mbMessageModelImpl.getColumnBitmask() &
					FINDER_PATH_COUNT_BY_T_P.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						Long.valueOf(mbMessageModelImpl.getOriginalThreadId()),
			...
			if ((mbMessageModelImpl.getColumnBitmask() &
					FINDER_PATH_COUNT_BY_T_S.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						Long.valueOf(mbMessageModelImpl.getOriginalThreadId()),
						Integer.valueOf(mbMessageModelImpl.getOriginalStatus())
					};
			...
			if ((mbMessageModelImpl.getColumnBitmask() &
					FINDER_PATH_COUNT_BY_TR_S.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						Long.valueOf(mbMessageModelImpl.getOriginalThreadId()),
						Integer.valueOf(mbMessageModelImpl.getOriginalStatus())
					};
			...
			if ((mbMessageModelImpl.getColumnBitmask() &
					FINDER_PATH_COUNT_BY_U_C_S.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						Long.valueOf(mbMessageModelImpl.getOriginalUserId()),
						Long.valueOf(mbMessageModelImpl.getOriginalClassNameId()),
						Integer.valueOf(mbMessageModelImpl.getOriginalStatus())
			...
			if ((mbMessageModelImpl.getColumnBitmask() &
					FINDER_PATH_COUNT_BY_C_C_S.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						Long.valueOf(mbMessageModelImpl.getOriginalClassNameId()),
						Long.valueOf(mbMessageModelImpl.getOriginalClassPK()),
						Integer.valueOf(mbMessageModelImpl.getOriginalStatus())
			...
			if ((mbMessageModelImpl.getColumnBitmask() &
					FINDER_PATH_COUNT_BY_G_C_T_A.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						Long.valueOf(mbMessageModelImpl.getOriginalGroupId()),
						Long.valueOf(mbMessageModelImpl.getOriginalCategoryId()),
						Long.valueOf(mbMessageModelImpl.getOriginalThreadId()),
			...
			if ((mbMessageModelImpl.getColumnBitmask() &
					FINDER_PATH_COUNT_BY_G_C_T_S.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						Long.valueOf(mbMessageModelImpl.getOriginalGroupId()),
						Long.valueOf(mbMessageModelImpl.getOriginalCategoryId()),
						Long.valueOf(mbMessageModelImpl.getOriginalThreadId()),
			...
			if ((mbMessageModelImpl.getColumnBitmask() &
					FINDER_PATH_COUNT_BY_U_C_C_S.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						Long.valueOf(mbMessageModelImpl.getOriginalUserId()),
						Long.valueOf(mbMessageModelImpl.getOriginalClassNameId()),
						Long.valueOf(mbMessageModelImpl.getOriginalClassPK()),
