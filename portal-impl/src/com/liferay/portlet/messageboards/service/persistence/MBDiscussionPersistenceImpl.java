...
public class MBDiscussionPersistenceImpl extends BasePersistenceImpl<MBDiscussion>
	...
	public List<MBDiscussion> findByClassNameId(long classNameId, int start,
		...
		List<MBDiscussion> list = (List<MBDiscussion>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_CLASSNAMEID,
				finderArgs, this);
	...
	public List<MBDiscussion> findAll(int start, int end,
		...
		List<MBDiscussion> list = (List<MBDiscussion>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_ALL,
				finderArgs, this);
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sql = _SQL_SELECT_MBDISCUSSION.concat(MBDiscussionModelImpl.ORDER_BY_JPQL);
			}
