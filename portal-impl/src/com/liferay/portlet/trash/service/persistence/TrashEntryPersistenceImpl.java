...
public class TrashEntryPersistenceImpl extends BasePersistenceImpl<TrashEntry>
	...
	public int countByG_LtCD(long groupId, Date createDate)
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_G_LTCD,
					finderArgs);
	...
	public List<TrashEntry> findAll(int start, int end,
		...
		List<TrashEntry> list = (List<TrashEntry>)FinderCacheUtil.getResult(FINDER_PATH_FIND_ALL,
				finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				if (orderByComparator != null) {
					...
					sql = _SQL_GETTRASHVERSIONS.concat(com.liferay.portlet.trash.model.impl.TrashVersionModelImpl.ORDER_BY_SQL);
				}
