...
public class ResourceResponseImpl
	...
	public void setCharacterEncoding(String charset) {
		...
		_canSetCharacterEncodingCallSetLocale = false;
	}
	...
	public void setLocale(Locale locale) {
		...
		if (_canSetCharacterEncodingCallSetLocale) {
			Portlet portlet = getPortlet();

			PortletApp portletApp = portlet.getPortletApp();

			ExtraPortletApp extraPortletApp =
				ExtraPortletApps.getExtraPortletApp(
			...
			if (characterEncoding != null) {
				...
				_canSetCharacterEncodingCallSetLocale = true;
			}
		}
	}

	private boolean _canSetCharacterEncodingCallSetLocale = true;
