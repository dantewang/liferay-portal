...
public class SocialActivitySettingPersistenceImpl extends BasePersistenceImpl<SocialActivitySetting>
	...
	public int countByG_C_A(long groupId, long classNameId, int activityType)
		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_G_C_A,
						finderArgs);
				}
				else {
	...
	public int countByG_C_A_N(long groupId, long classNameId, int activityType,
		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_G_C_A_N,
						finderArgs);
				}
				else {
	...
	public List<SocialActivitySetting> findAll(int start, int end,
		...
		List<SocialActivitySetting> list = (List<SocialActivitySetting>)FinderCacheUtil.getResult(FINDER_PATH_FIND_ALL,
				finderArgs, this);
