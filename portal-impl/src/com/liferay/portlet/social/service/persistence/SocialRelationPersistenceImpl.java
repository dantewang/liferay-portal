	...
	public int countByUserId1(long userId1) throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_USERID1,
						finderArgs);
				}
				else {
	...
	public int countByUserId2(long userId2) throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_USERID2,
						finderArgs);
				}
				else {
	...
	public int countByType(int type) throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_TYPE,
						finderArgs);
				}
				else {
	...
	public int countByC_T(long companyId, int type) throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_C_T,
						finderArgs);
				}
				else {
					FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_C_T,
						finderArgs, count);
				}
	...
	public int countByU1_U2(long userId1, long userId2)
		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_U1_U2,
						finderArgs);
				}
				else {
	...
	public int countByU1_T(long userId1, int type) throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_U1_T,
						finderArgs);
				}
				else {
	...
	public int countByU2_T(long userId2, int type) throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_U2_T,
						finderArgs);
				}
				else {
	...
	public int countByU1_U2_T(long userId1, long userId2, int type)
		...
		if (count == null) {
			...
			try {
				...
				if (count == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_U1_U2_T,
						finderArgs);
				}
				else {
