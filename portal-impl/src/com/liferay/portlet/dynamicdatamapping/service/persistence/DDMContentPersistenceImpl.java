...
public class DDMContentPersistenceImpl extends BasePersistenceImpl<DDMContent>
	...
	public List<DDMContent> findByUuid(String uuid, int start, int end,
		...
		List<DDMContent> list = (List<DDMContent>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID,
				finderArgs, this);
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID_G = new FinderPath(DDMContentModelImpl.ENTITY_CACHE_ENABLED,
			DDMContentModelImpl.FINDER_CACHE_ENABLED, DDMContentImpl.class,
	...
	public List<DDMContent> findByUuid_C(String uuid, long companyId,
		...
		List<DDMContent> list = (List<DDMContent>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID_C,
				finderArgs, this);
	...
	public List<DDMContent> findByGroupId(long groupId, int start, int end,
		...
		List<DDMContent> list = (List<DDMContent>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUPID,
				finderArgs, this);
	...
	public List<DDMContent> findByCompanyId(long companyId, int start, int end,
		...
		List<DDMContent> list = (List<DDMContent>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_COMPANYID,
				finderArgs, this);
	...
	public List<DDMContent> findAll(int start, int end,
		...
		List<DDMContent> list = (List<DDMContent>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_ALL,
				finderArgs, this);
