...
public class WikiPagePersistenceImpl extends BasePersistenceImpl<WikiPage>
	...
	public int countByNodeId(long nodeId) throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_NODEID,
					finderArgs);
	...
	public int countByFormat(String format) throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_FORMAT,
					finderArgs);
	...
	public List<WikiPage> findByR_N(long resourcePrimKey, long nodeId,
		...
		if (list == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_R_N, finderArgs);
	...
	public int countByR_N(long resourcePrimKey, long nodeId)
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_R_N,
					finderArgs);
	...
	public List<WikiPage> findByN_T(long nodeId, String title, int start,
		...
		if (list == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_N_T, finderArgs);
	...
	public int countByN_T(long nodeId, String title) throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_N_T,
					finderArgs);
	...
	public List<WikiPage> findByN_H(long nodeId, boolean head, int start,
		...
		if (list == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_N_H, finderArgs);
	...
	public int countByN_H(long nodeId, boolean head) throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_N_H,
					finderArgs);
	...
	public List<WikiPage> findByN_P(long nodeId, String parentTitle, int start,
		...
		if (list == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_N_P, finderArgs);
	...
	public int countByN_P(long nodeId, String parentTitle)
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_N_P,
					finderArgs);
	...
	public List<WikiPage> findByN_R(long nodeId, String redirectTitle,
		...
		if (list == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_N_R, finderArgs);
	...
	public int countByN_R(long nodeId, String redirectTitle)
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_N_R,
					finderArgs);
	...
	public List<WikiPage> findByN_S(long nodeId, int status, int start,
		...
		if (list == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_FIND_BY_N_S, finderArgs);
	...
	public int countByN_S(long nodeId, int status) throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_N_S,
					finderArgs);
	...
	public int countByR_N_V(long resourcePrimKey, long nodeId, double version)
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_R_N_V,
					finderArgs);
	...
	public int countByR_N_H(long resourcePrimKey, long nodeId, boolean head)
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_R_N_H,
					finderArgs);
	...
	public int countByR_N_S(long resourcePrimKey, long nodeId, int status)
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_R_N_S,
					finderArgs);
	...
	public int countByU_N_S(long userId, long nodeId, int status)
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_U_N_S,
					finderArgs);
	...
	public int countByN_T_V(long nodeId, String title, double version)
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_N_T_V,
					finderArgs);
	...
	public int countByN_T_H(long nodeId, String title, boolean head)
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_N_T_H,
					finderArgs);
	...
	public int countByN_T_S(long nodeId, String title, int status)
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_N_T_S,
					finderArgs);
	...
	public int countByN_H_P(long nodeId, boolean head, String parentTitle)
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_N_H_P,
					finderArgs);
	...
	public int countByN_H_S(long nodeId, boolean head, int status)
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_N_H_S,
					finderArgs);
	...
	public int countByN_H_P_S(long nodeId, boolean head, String parentTitle,
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_N_H_P_S,
					finderArgs);
	...
	public WikiPage updateImpl(com.liferay.portlet.wiki.model.WikiPage wikiPage)
		...
		if (isNew || !WikiPageModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((wikiPageModelImpl.getColumnBitmask() &
					FINDER_PATH_COUNT_BY_NODEID.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
			...
			if ((wikiPageModelImpl.getColumnBitmask() &
					FINDER_PATH_COUNT_BY_FORMAT.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
			...
			if ((wikiPageModelImpl.getColumnBitmask() &
					FINDER_PATH_COUNT_BY_R_N.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
			...
			if ((wikiPageModelImpl.getColumnBitmask() &
					FINDER_PATH_COUNT_BY_N_H.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						Long.valueOf(wikiPageModelImpl.getOriginalNodeId()),
			...
			if ((wikiPageModelImpl.getColumnBitmask() &
					FINDER_PATH_COUNT_BY_N_P.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						Long.valueOf(wikiPageModelImpl.getOriginalNodeId()),
			...
			if ((wikiPageModelImpl.getColumnBitmask() &
					FINDER_PATH_COUNT_BY_N_R.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						Long.valueOf(wikiPageModelImpl.getOriginalNodeId()),
			...
			if ((wikiPageModelImpl.getColumnBitmask() &
					FINDER_PATH_COUNT_BY_N_S.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						Long.valueOf(wikiPageModelImpl.getOriginalNodeId()),
			...
			if ((wikiPageModelImpl.getColumnBitmask() &
					FINDER_PATH_COUNT_BY_R_N_H.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						Long.valueOf(wikiPageModelImpl.getOriginalResourcePrimKey()),
						Long.valueOf(wikiPageModelImpl.getOriginalNodeId()),
						Boolean.valueOf(wikiPageModelImpl.getOriginalHead())
			...
			if ((wikiPageModelImpl.getColumnBitmask() &
					FINDER_PATH_COUNT_BY_R_N_S.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						Long.valueOf(wikiPageModelImpl.getOriginalResourcePrimKey()),
						Long.valueOf(wikiPageModelImpl.getOriginalNodeId()),
						Integer.valueOf(wikiPageModelImpl.getOriginalStatus())
			...
			if ((wikiPageModelImpl.getColumnBitmask() &
					FINDER_PATH_COUNT_BY_U_N_S.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
			...
			if ((wikiPageModelImpl.getColumnBitmask() &
					FINDER_PATH_COUNT_BY_N_T_H.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						Long.valueOf(wikiPageModelImpl.getOriginalNodeId()),
			...
			if ((wikiPageModelImpl.getColumnBitmask() &
					FINDER_PATH_COUNT_BY_N_T_S.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						Long.valueOf(wikiPageModelImpl.getOriginalNodeId()),
			...
			if ((wikiPageModelImpl.getColumnBitmask() &
					FINDER_PATH_COUNT_BY_N_H_P.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						Long.valueOf(wikiPageModelImpl.getOriginalNodeId()),
						Boolean.valueOf(wikiPageModelImpl.getOriginalHead()),
			...
			if ((wikiPageModelImpl.getColumnBitmask() &
					FINDER_PATH_COUNT_BY_N_H_S.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						Long.valueOf(wikiPageModelImpl.getOriginalNodeId()),
						Boolean.valueOf(wikiPageModelImpl.getOriginalHead()),
						Integer.valueOf(wikiPageModelImpl.getOriginalStatus())
			...
			if ((wikiPageModelImpl.getColumnBitmask() &
					FINDER_PATH_COUNT_BY_N_H_P_S.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						Long.valueOf(wikiPageModelImpl.getOriginalNodeId()),
						Boolean.valueOf(wikiPageModelImpl.getOriginalHead()),
