...
public class AnnouncementsEntryPersistenceImpl extends BasePersistenceImpl<AnnouncementsEntry>
	...
	public List<AnnouncementsEntry> findByUuid(String uuid, int start, int end,
		...
		List<AnnouncementsEntry> list = (List<AnnouncementsEntry>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID,
				finderArgs, this);
	...
	public List<AnnouncementsEntry> findByUuid_C(String uuid, long companyId,
		...
		List<AnnouncementsEntry> list = (List<AnnouncementsEntry>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID_C,
				finderArgs, this);
	...
	public List<AnnouncementsEntry> findByUserId(long userId, int start,
		...
		List<AnnouncementsEntry> list = (List<AnnouncementsEntry>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_USERID,
				finderArgs, this);
	...
	public List<AnnouncementsEntry> findByC_C(long classNameId, long classPK,
		...
		List<AnnouncementsEntry> list = (List<AnnouncementsEntry>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_C_C,
				finderArgs, this);
	...
	public List<AnnouncementsEntry> findByC_C_A(long classNameId, long classPK,
		...
		List<AnnouncementsEntry> list = (List<AnnouncementsEntry>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_C_C_A,
				finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				if (list == null) {
					FinderCacheUtil.removeResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_C_C_A,
						finderArgs);
				}
				else {
					cacheResult(list);

					FinderCacheUtil.putResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_C_C_A,
						finderArgs, list);
				}
	...
	public AnnouncementsEntry findByC_C_A_First(long classNameId, long classPK,
		boolean alert) throws NoSuchEntryException, SystemException {
		return findByC_C_A_First(classNameId, classPK, alert, null);
	}
	...
	public AnnouncementsEntry fetchByC_C_A_First(long classNameId,
		long classPK, boolean alert) throws SystemException {
		return fetchByC_C_A_First(classNameId, classPK, alert, null);
	}
	...
	public AnnouncementsEntry findByC_C_A_Last(long classNameId, long classPK,
		boolean alert) throws NoSuchEntryException, SystemException {
		return findByC_C_A_Last(classNameId, classPK, alert, null);
	}
	...
	public AnnouncementsEntry fetchByC_C_A_Last(long classNameId, long classPK,
		boolean alert) throws SystemException {
		return fetchByC_C_A_Last(classNameId, classPK, alert, null);
	}
	...
	public AnnouncementsEntry updateImpl(
		...
		if (isNew || !AnnouncementsEntryModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((announcementsEntryModelImpl.getColumnBitmask() &
					FINDER_PATH_COUNT_BY_C_C_A.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						Long.valueOf(announcementsEntryModelImpl.getOriginalClassNameId()),
						Long.valueOf(announcementsEntryModelImpl.getOriginalClassPK()),
	...
	public List<AnnouncementsEntry> findAll(int start, int end,
		...
		List<AnnouncementsEntry> list = (List<AnnouncementsEntry>)FinderCacheUtil.getResult(FINDER_PATH_WITH_PAGINATION_FIND_ALL,
				finderArgs, this);
