...
public class UnicodeFormatterTest {
	...
	public void testByteToHexChars() {
		...
		resultHexChars = UnicodeFormatter.byteToHex((byte)255, hexChars, false);

		Assert.assertArrayEquals(expectedHexChars, resultHexChars);
		Assert.assertSame(hexChars, resultHexChars);

		UnicodeFormatter.byteToHexCharArray((byte)255, hexChars);

		Assert.assertArrayEquals(expectedHexChars, hexChars);
		...
		UnicodeFormatter.byteToHexCharArray((byte)255, hexChars, true);
