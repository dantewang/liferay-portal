...
public class SystemPropertiesTest {
	...
	public void testGet() {
		...
		String testNoReferenceKey = "test.no.existent.reference.key";
		...
		String testLeftReferenceValue =
			"leftValue.${" + testReferenceKey + StringPool.CLOSE_CURLY_BRACE;
		...
		String testRightReferenceKey = "test.right.reference.key";
		String testRightReferenceValue =
			StringPool.DOLLAR_AND_OPEN_CURLY_BRACE + testReferenceKey +
				"}.rightValue";

		Assert.assertNull(SystemProperties.get(testRightReferenceKey));

		SystemProperties.set(testRightReferenceKey, testRightReferenceValue);

		Assert.assertEquals(
			_TEST_VALUE + ".rightValue",
			SystemProperties.get(testRightReferenceKey));

		String testBlankReferenceKey = "test.blank.reference.key";
		String testBlankReferenceValue = "blankValue.${}";
	...
	public void testLoad() throws IOException, URISyntaxException {
		File systemPropertiesFile = null;

		try {
			String userDir = System.getProperty("user.dir");

			userDir = StringUtil.replace(
				userDir, CharPool.BACK_SLASH, CharPool.FORWARD_SLASH);

			systemPropertiesFile = new File(
