...
public class URLCodecTest {
	...
	public void testDecodeURL() {
		...
		_testCharacterCodingException(
			charset -> URLCodec.decodeURL("%00", charset));
	}
	...
	public void testEncodeURL() {
		...
		_testCharacterCodingException(
			charset -> URLCodec.encodeURL("!", charset, false));
	}
	...
	private void _testCharacterCodingException(
		...
		try (CaptureHandler captureHandler =
			...
			Assert.assertTrue(
				"CharacterCodingException should be logged by the logger",
				logRecord.getThrown() instanceof CharacterCodingException);
			Assert.assertEquals(
