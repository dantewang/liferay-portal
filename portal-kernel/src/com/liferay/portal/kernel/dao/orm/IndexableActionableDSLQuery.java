 ...
 * @author Dante Wang
 */
public class IndexableActionableDSLQuery extends DefaultActionableDSLQuery {

	public IndexableActionableDSLQuery(Class<?> modelClass) {
	...
	private static final Snapshot<IndexWriterHelper>
		_indexWriterHelperProxySnapshot = new Snapshot<>(
			IndexableActionableDSLQuery.class, IndexWriterHelper.class);
