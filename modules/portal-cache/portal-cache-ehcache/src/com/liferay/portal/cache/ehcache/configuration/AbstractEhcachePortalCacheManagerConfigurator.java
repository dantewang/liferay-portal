...
public abstract class AbstractEhcachePortalCacheManagerConfigurator
	...
	public PortalCacheManagerConfiguration
			getConfigurationObjectValuePair(
				String portalCacheManagerName, Configuration ehcacheConfiguration,
	...
	public void handlePeerFactoryConfigurations(
	...
	public PortalCacheConfiguration parseCacheConfiguration(
		...
		for (CacheEventListenerFactoryConfiguration
			...
			String factoryClassName = CacheConfigurationHelperUtil.parseFactoryClassName(
				cacheEventListenerFactoryConfiguration.
		...
		if (bootstrapCacheLoaderFactoryConfiguration != null) {
			portalCacheBootstrapLoaderProperties = CacheConfigurationHelperUtil.parseProperties(
