...
create index IX_CA916721 on OSBFaro_FaroNotification (createTime, groupId, ownerId, type_[$COLUMN_LENGTH:75$], subtype[$COLUMN_LENGTH:75$], read_);
...
create unique index IX_8BCC324C on OSBFaro_FaroUser (groupId, emailAddress[$COLUMN_LENGTH:75$]);
