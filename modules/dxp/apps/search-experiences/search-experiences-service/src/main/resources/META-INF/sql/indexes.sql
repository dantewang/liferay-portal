...
create index IX_311BC71A on SXPBlueprint (companyId, uuid_[$COLUMN_LENGTH:75$]);
...
create index IX_DFC249BE on SXPElement (companyId, type_, status);
create index IX_9C55B643 on SXPElement (companyId, uuid_[$COLUMN_LENGTH:75$]);
