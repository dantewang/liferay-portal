...
public abstract class BaseBatchEngineTaskItemDelegate<T>
	...
	protected Page<T> search(
			DTOConverter<?, T> dtoConverter, Indexer<?> indexer, Filter filter,
			Pagination pagination, Sort[] sorts, String search)
		throws Exception {
		...
		com.liferay.portal.vulcan.pagination.Page<T> page = SearchUtil.search(
			null, Query::getPreBooleanFilter, filter, indexer, search,
			vulcanPagination,
