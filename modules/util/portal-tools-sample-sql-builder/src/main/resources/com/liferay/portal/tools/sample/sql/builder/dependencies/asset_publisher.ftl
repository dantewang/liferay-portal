...
<#list pageCounts as pageCount>
	...
	${dataFactory.toInsertSQL(dataFactory.newPortletPreferencesModel(layoutModel.plid, groupId, portletId, pageCount, assetCategoryModelsMaps, assetTagModelsMaps))}
</#list>