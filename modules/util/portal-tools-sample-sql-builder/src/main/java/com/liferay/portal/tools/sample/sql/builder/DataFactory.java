...
public class DataFactory {
	...
	public void initContext(Properties properties)
		...
		String defaultTimeZone = String.valueOf(TimeZone.getDefault());

		int startIndex = defaultTimeZone.indexOf("id=");
		int endIndex = defaultTimeZone.indexOf(",");

		Writer writer = new BufferedWriter(
			new FileWriter(new File(outputDir, "defaultTimeZone.csv")));

		writer.write(defaultTimeZone.substring(startIndex + 4, endIndex - 1));
		writer.close();
	}
