...
public class DataFactory {
	...
	public DataFactory() throws Exception {
		...
		initJournalArticleContent(PropsValues.MAX_JOURNAL_ARTICLE_SIZE);

		initRoleModels();
		initUserNames();
		initUserModels();
		initVirtualHostModel(PropsValues.VIRTUAL_HOST_NAME);
	}
	...
	public void initGroupModels() throws Exception {
		...
		_groupModels = new ArrayList<>(PropsValues.MAX_GROUP_COUNT);
