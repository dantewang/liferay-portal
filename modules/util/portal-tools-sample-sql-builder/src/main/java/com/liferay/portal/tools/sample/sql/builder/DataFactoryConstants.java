...
public interface DataFactoryConstants {
	...
	public static final String DL_SUFFIX = "." + DL_EXTENSION;
	...
	public static final String MB_ROOT_BODY_CONTENT = MB_BODY_PREFIX + "1.";

	public static final String MB_ROOT_SUBJECT_CONTENT =
