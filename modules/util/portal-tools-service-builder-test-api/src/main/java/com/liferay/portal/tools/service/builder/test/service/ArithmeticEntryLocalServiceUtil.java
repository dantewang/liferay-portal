...
/**
 * Provides the local service utility for ArithmeticEntry. This utility wraps
 * <code>com.liferay.portal.tools.service.builder.test.service.impl.ArithmeticEntryLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ArithmeticEntryLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.portal.tools.service.builder.test.service.impl.ArithmeticEntryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ArithmeticEntry addArithmeticEntry(
		ArithmeticEntry arithmeticEntry) {

		return getService().addArithmeticEntry(arithmeticEntry);
	}
	 ...
	 */
	public static ArithmeticEntry createArithmeticEntry(
		long arithmeticEntryId) {

		return getService().createArithmeticEntry(arithmeticEntryId);
	}
	 ...
	 */
	public static ArithmeticEntry deleteArithmeticEntry(
		ArithmeticEntry arithmeticEntry) {

		return getService().deleteArithmeticEntry(arithmeticEntry);
	}
	 ...
	 */
	public static ArithmeticEntry deleteArithmeticEntry(long arithmeticEntryId)
		throws PortalException {

		return getService().deleteArithmeticEntry(arithmeticEntryId);
	}
	...
	public static ArithmeticEntry fetchArithmeticEntry(long arithmeticEntryId) {
		return getService().fetchArithmeticEntry(arithmeticEntryId);
	}
	 ...
	 */
	public static List<ArithmeticEntry> getArithmeticEntries(
		int start, int end) {

		return getService().getArithmeticEntries(start, end);
	}
	 ...
	 */
	public static int getArithmeticEntriesCount() {
		return getService().getArithmeticEntriesCount();
	}
	 ...
	 * @throws PortalException if a arithmetic entry with the primary key could not be found
	 */
	public static ArithmeticEntry getArithmeticEntry(long arithmeticEntryId)
		throws PortalException {

		return getService().getArithmeticEntry(arithmeticEntryId);
	}
	 ...
	 */
	public static ArithmeticEntry updateArithmeticEntry(
		ArithmeticEntry arithmeticEntry) {

		return getService().updateArithmeticEntry(arithmeticEntry);
	}

	public static ArithmeticEntryLocalService getService() {
		return _service;
	}

	public static void setService(ArithmeticEntryLocalService service) {
		_service = service;
	}

	private static volatile ArithmeticEntryLocalService _service;
