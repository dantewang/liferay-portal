...
/**
 * Provides the local service interface for NotCachedEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see NotCachedEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface NotCachedEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.portal.tools.service.builder.test.service.impl.NotCachedEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the not cached entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link NotCachedEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public NotCachedEntry addNotCachedEntry(NotCachedEntry notCachedEntry);
	...
	public NotCachedEntry createNotCachedEntry(long nestedSetsTreeEntryId);
	...
	public NotCachedEntry deleteNotCachedEntry(long nestedSetsTreeEntryId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public NotCachedEntry deleteNotCachedEntry(NotCachedEntry notCachedEntry);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NotCachedEntry fetchNotCachedEntry(long nestedSetsTreeEntryId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NotCachedEntry getNotCachedEntry(long nestedSetsTreeEntryId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public NotCachedEntry updateNotCachedEntry(NotCachedEntry notCachedEntry);
