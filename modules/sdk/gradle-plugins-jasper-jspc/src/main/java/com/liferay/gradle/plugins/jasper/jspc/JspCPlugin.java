...
public class JspCPlugin implements Plugin<Project> {
	...
	private void _addDependenciesJspC(Project project) {
		...
		GradleUtil.addDependency(
			...
			"9.0.97");
		GradleUtil.addDependency(
			project, CONFIGURATION_NAME, "org.apache.tomcat", "tomcat-el-api",
			"9.0.97");
		GradleUtil.addDependency(
		...
		GradleUtil.addDependency(
			...
			"tomcat-jasper-el", "9.0.97");
		GradleUtil.addDependency(
			project, CONFIGURATION_NAME, "org.apache.tomcat", "tomcat-jsp-api",
			"9.0.97");
		GradleUtil.addDependency(
