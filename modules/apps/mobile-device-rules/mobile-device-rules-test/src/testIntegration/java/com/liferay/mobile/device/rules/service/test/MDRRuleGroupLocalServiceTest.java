...
public class MDRRuleGroupLocalServiceTest {
	...
	public void testCopyRuleGroup() throws Exception {
		...
		Assert.assertNotEquals(_ruleGroup, newRuleGroup);
		...
		List<ResourcePermission> newResourcePermissions =
			_resourcePermissionLocalService.getResourcePermissions(
				newRuleGroup.getCompanyId(), MDRRuleGroup.class.getName(),
				ResourceConstants.SCOPE_INDIVIDUAL,
	...
	@Test
	public void testCopyRuleGroupWithoutOwnerViewPermission() throws Exception {
