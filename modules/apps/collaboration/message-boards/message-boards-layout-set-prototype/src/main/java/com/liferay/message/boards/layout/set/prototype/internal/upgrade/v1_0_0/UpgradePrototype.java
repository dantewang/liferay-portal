 ...
 * @author Leon Chi
 */
public class UpgradePrototype extends BaseUpgradePrototype {
	...
	protected void doUpgrade() throws Exception {
		...
		upgradePrototypes(
			clazz, resourceBundleLoader, "LayoutSetPrototype",
			"%Community Site%", "layout-set-prototype-community-site-title",
