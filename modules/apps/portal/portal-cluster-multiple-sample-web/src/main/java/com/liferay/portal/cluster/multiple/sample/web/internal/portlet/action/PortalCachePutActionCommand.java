...
@Component(
	...
	property = {
		...
		"mvc.command.name=/cluster/cache_put"
	},
	service = MVCActionCommand.class
)
public class PortalCachePutActionCommand extends BaseMVCActionCommand {
	...
	protected void doProcessAction(
		...
		String cacheKey = ParamUtil.getString(actionRequest, "key");

		portalCache.put(cacheKey, ParamUtil.getString(actionRequest, "value"));
	}
