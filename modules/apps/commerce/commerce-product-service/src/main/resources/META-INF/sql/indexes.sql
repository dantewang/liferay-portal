...
create index IX_A6E0353A on CPAttachmentFileEntry (classNameId, classPK, status, type_);
...
create index IX_C399720F on CPInstance (CPDefinitionId, status, displayDate);
