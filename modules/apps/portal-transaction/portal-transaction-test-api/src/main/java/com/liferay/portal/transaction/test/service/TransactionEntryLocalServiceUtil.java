...
/**
 * Provides the local service utility for TransactionEntry. This utility wraps
 * <code>com.liferay.portal.transaction.test.service.impl.TransactionEntryLocalServiceImpl</code> and
 ...
 */
@ProviderType
public class TransactionEntryLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.portal.transaction.test.service.impl.TransactionEntryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.liferay.portal.transaction.test.model.TransactionEntry
		addTransactionEntry(
			com.liferay.portal.transaction.test.model.TransactionEntry
				transactionEntry) {

		return getService().addTransactionEntry(transactionEntry);
	}
	...
	public static com.liferay.portal.transaction.test.model.TransactionEntry
		...
		return getService().createTransactionEntry(transactionEntryId);
	}
	...
	public static com.liferay.portal.transaction.test.model.TransactionEntry
		...
		return getService().deleteTransactionEntry(transactionEntryId);
	}
	...
	public static com.liferay.portal.transaction.test.model.TransactionEntry
		...
		return getService().deleteTransactionEntry(transactionEntry);
	}
	...
	public static com.liferay.portal.transaction.test.model.TransactionEntry
		...
		return getService().fetchTransactionEntry(transactionEntryId);
	}
	...
	public static java.util.List
		...
		return getService().getTransactionEntries(start, end);
	}
	 ...
	 */
	public static int getTransactionEntriesCount() {
		return getService().getTransactionEntriesCount();
	}
	...
	public static com.liferay.portal.transaction.test.model.TransactionEntry
		...
		return getService().getTransactionEntry(transactionEntryId);
	}
	...
	public static com.liferay.portal.transaction.test.model.TransactionEntry
		...
		return getService().updateTransactionEntry(transactionEntry);
	}

	public static TransactionEntryLocalService getService() {
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			TransactionEntryLocalService.class);
					...
					new ServiceTracker
						<TransactionEntryLocalService,
						 TransactionEntryLocalService>(
							 ...
							 TransactionEntryLocalService.class, null);
