...
/**
 * Provides the local service interface for TransactionEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TransactionEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TransactionEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TransactionEntryLocalServiceUtil} to access the transaction entry local service. Add custom service methods to <code>com.liferay.portal.transaction.test.service.impl.TransactionEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
