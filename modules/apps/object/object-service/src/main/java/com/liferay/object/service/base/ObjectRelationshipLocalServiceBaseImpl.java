...
public abstract class ObjectRelationshipLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(objectRelationshipLocalService);
		actionableDSLQuery.setTable(ObjectRelationshipTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("objectRelationshipId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(ObjectRelationship.class);

		indexableActionableDSLQuery.setBaseLocalService(
			objectRelationshipLocalService);
		indexableActionableDSLQuery.setTable(ObjectRelationshipTable.INSTANCE);
	...
	public ExportActionableDSLQuery getExportActionableDSLQuery(
		...
		exportActionableDSLQuery.buildDSL(
			dslBuilder -> {
				...
				predicate = portletDataContext.getDateRangePredicate(
					ObjectRelationshipTable.INSTANCE.modifiedDate);
		...
		exportActionableDSLQuery.setPerformActionMethod(
			new ActionableDSLQuery.PerformActionMethod<ObjectRelationship>() {
