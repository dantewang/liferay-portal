...
public abstract class ObjectLayoutTabLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(objectLayoutTabLocalService);
		actionableDSLQuery.setTable(ObjectLayoutTabTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("objectLayoutTabId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(ObjectLayoutTab.class);

		indexableActionableDSLQuery.setBaseLocalService(
			objectLayoutTabLocalService);
		indexableActionableDSLQuery.setTable(ObjectLayoutTabTable.INSTANCE);
	...
	public ExportActionableDSLQuery getExportActionableDSLQuery(
		...
		exportActionableDSLQuery.buildDSL(
			dslBuilder -> {
				...
				predicate = portletDataContext.getDateRangePredicate(
					ObjectLayoutTabTable.INSTANCE.modifiedDate);
		...
		exportActionableDSLQuery.setPerformActionMethod(
			new ActionableDSLQuery.PerformActionMethod<ObjectLayoutTab>() {
