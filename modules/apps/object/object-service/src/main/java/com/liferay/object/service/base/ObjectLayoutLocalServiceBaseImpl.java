...
public abstract class ObjectLayoutLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(objectLayoutLocalService);
		actionableDSLQuery.setTable(ObjectLayoutTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("objectLayoutId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(ObjectLayout.class);

		indexableActionableDSLQuery.setBaseLocalService(
			objectLayoutLocalService);
		indexableActionableDSLQuery.setTable(ObjectLayoutTable.INSTANCE);

		indexableActionableDSLQuery.setPrimaryKeyPropertyName("objectLayoutId");
	...
	public ExportActionableDSLQuery getExportActionableDSLQuery(
		...
		exportActionableDSLQuery.buildDSL(
			dslBuilder -> {
				...
				predicate = portletDataContext.getDateRangePredicate(
					ObjectLayoutTable.INSTANCE.modifiedDate);
		...
		exportActionableDSLQuery.setPerformActionMethod(
			new ActionableDSLQuery.PerformActionMethod<ObjectLayout>() {
