...
public abstract class ObjectStateLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(objectStateLocalService);
		actionableDSLQuery.setTable(ObjectStateTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("objectStateId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(ObjectState.class);

		indexableActionableDSLQuery.setBaseLocalService(
			objectStateLocalService);
		indexableActionableDSLQuery.setTable(ObjectStateTable.INSTANCE);

		indexableActionableDSLQuery.setPrimaryKeyPropertyName("objectStateId");
	...
	public ExportActionableDSLQuery getExportActionableDSLQuery(
		...
		exportActionableDSLQuery.buildDSL(
			dslBuilder -> {
				...
				predicate = portletDataContext.getDateRangePredicate(
					ObjectStateTable.INSTANCE.modifiedDate);
		...
		exportActionableDSLQuery.setPerformActionMethod(
			new ActionableDSLQuery.PerformActionMethod<ObjectState>() {
