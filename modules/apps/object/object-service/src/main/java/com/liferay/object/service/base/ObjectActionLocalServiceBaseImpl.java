...
public abstract class ObjectActionLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(objectActionLocalService);
		actionableDSLQuery.setTable(ObjectActionTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("objectActionId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(ObjectAction.class);

		indexableActionableDSLQuery.setBaseLocalService(
			objectActionLocalService);
		indexableActionableDSLQuery.setTable(ObjectActionTable.INSTANCE);

		indexableActionableDSLQuery.setPrimaryKeyPropertyName("objectActionId");
	...
	public ExportActionableDSLQuery getExportActionableDSLQuery(
		...
		exportActionableDSLQuery.buildDSL(
			dslBuilder -> {
				...
				predicate = portletDataContext.getDateRangePredicate(
					ObjectActionTable.INSTANCE.modifiedDate);
		...
		exportActionableDSLQuery.setPerformActionMethod(
			new ActionableDSLQuery.PerformActionMethod<ObjectAction>() {
