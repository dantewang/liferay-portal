...
public abstract class ObjectEntryFolderLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(objectEntryFolderLocalService);
		actionableDSLQuery.setTable(ObjectEntryFolderTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("objectEntryFolderId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(ObjectEntryFolder.class);

		indexableActionableDSLQuery.setBaseLocalService(
			objectEntryFolderLocalService);
		indexableActionableDSLQuery.setTable(ObjectEntryFolderTable.INSTANCE);
	...
	public ExportActionableDSLQuery getExportActionableDSLQuery(
		...
		exportActionableDSLQuery.buildDSL(
			dslBuilder -> {
				...
				predicate = portletDataContext.getDateRangePredicate(
					ObjectEntryFolderTable.INSTANCE.modifiedDate);
		...
		exportActionableDSLQuery.setPerformActionMethod(
			new ActionableDSLQuery.PerformActionMethod<ObjectEntryFolder>() {
