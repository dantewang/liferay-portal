...
public abstract class ObjectStateFlowLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(objectStateFlowLocalService);
		actionableDSLQuery.setTable(ObjectStateFlowTable.INSTANCE);

		actionableDSLQuery.setPrimaryKeyPropertyName("objectStateFlowId");
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(ObjectStateFlow.class);

		indexableActionableDSLQuery.setBaseLocalService(
			objectStateFlowLocalService);
		indexableActionableDSLQuery.setTable(ObjectStateFlowTable.INSTANCE);
	...
	public ExportActionableDSLQuery getExportActionableDSLQuery(
		...
		exportActionableDSLQuery.buildDSL(
			dslBuilder -> {
				...
				predicate = portletDataContext.getDateRangePredicate(
					ObjectStateFlowTable.INSTANCE.modifiedDate);
		...
		exportActionableDSLQuery.setPerformActionMethod(
			new ActionableDSLQuery.PerformActionMethod<ObjectStateFlow>() {
