...
public abstract class ObjectValidationRuleSettingLocalServiceBaseImpl
	...
	public ActionableDSLQuery getActionableDSLQuery() {
		...
		actionableDSLQuery.setBaseLocalService(
			objectValidationRuleSettingLocalService);
		actionableDSLQuery.setTable(ObjectValidationRuleSettingTable.INSTANCE);
	...
	public IndexableActionableDSLQuery getIndexableActionableDSLQuery() {
		IndexableActionableDSLQuery indexableActionableDSLQuery =
			new IndexableActionableDSLQuery(ObjectValidationRuleSetting.class);
		...
		exportActionableDSLQuery.buildDSL(
			dslBuilder -> {
				...
				predicate = portletDataContext.getDateRangePredicate(
					ObjectValidationRuleSettingTable.INSTANCE.modifiedDate);
