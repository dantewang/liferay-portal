...
public class MBThreadPersistenceImpl
	...
	public List<MBThread> findByG_L(long groupId, Date lastPostDate) {
		return findByG_L(
			groupId, lastPostDate, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<MBThread> findByG_L(
	...
	public List<MBThread> findByG_L(
		...
		return findByG_L(
			groupId, lastPostDate, start, end, orderByComparator, true);
	}
	...
	public List<MBThread> findByG_L(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache && productionMode) {
				...
				finderArgs = new Object[] {groupId, _getTime(lastPostDate)};
			}
		}
		else if (useFinderCache && productionMode) {
			finderPath = _finderPathWithPaginationFindByG_L;
			finderArgs = new Object[] {
				groupId, _getTime(lastPostDate), start, end, orderByComparator
			};
		}
		...
		if (list == null) {
			...
			if (lastPostDate == null) {
				sb.append(_FINDER_COLUMN_G_L_LASTPOSTDATE_1);
			}
			else {
				bindLastPostDate = true;

				sb.append(_FINDER_COLUMN_G_L_LASTPOSTDATE_2);
			}
	...
	public MBThread findByG_L_First(
		...
		MBThread mbThread = fetchByG_L_First(
			groupId, lastPostDate, orderByComparator);
	...
	public MBThread fetchByG_L_First(
		...
		List<MBThread> list = findByG_L(
			groupId, lastPostDate, 0, 1, orderByComparator);
	...
	public MBThread findByG_L_Last(
		...
		MBThread mbThread = fetchByG_L_Last(
			groupId, lastPostDate, orderByComparator);
	...
	public MBThread fetchByG_L_Last(
		...
		List<MBThread> list = findByG_L(
			groupId, lastPostDate, count - 1, count, orderByComparator);
	...
	public MBThread[] findByG_L_PrevAndNext(
		...
		try {
			...
			array[0] = getByG_L_PrevAndNext(
				session, mbThread, groupId, lastPostDate, orderByComparator,
				true);
	...
	protected MBThread getByG_L_PrevAndNext(
		Session session, MBThread mbThread, long groupId, Date lastPostDate,
		OrderByComparator<MBThread> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public List<MBThread> filterFindByG_L(
		long groupId, Date lastPostDate, int start, int end) {
	...
	public List<MBThread> filterFindByG_L(
		...
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_L(
				groupId, lastPostDate, start, end, orderByComparator);
		}
	...
	public MBThread[] filterFindByG_L_PrevAndNext(
		...
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_L_PrevAndNext(
				threadId, groupId, lastPostDate, orderByComparator);
		}
	...
	protected MBThread filterGetByG_L_PrevAndNext(
		Session session, MBThread mbThread, long groupId, Date lastPostDate,
		OrderByComparator<MBThread> orderByComparator, boolean previous) {
	...
	public void removeByG_L(long groupId, Date lastPostDate) {
		for (MBThread mbThread :
				findByG_L(
					groupId, lastPostDate, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
					null)) {
	...
	private static final String _FINDER_COLUMN_G_L_LASTPOSTDATE_1 =
		"mbThread.lastPostDate IS NULL";

	private static final String _FINDER_COLUMN_G_L_LASTPOSTDATE_2 =
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByG_L = new FinderPath(
			...
			new String[] {"groupId", "lastPostDate"}, true);
		...
		_finderPathCountByG_L = new FinderPath(
			...
			new String[] {Long.class.getName(), Date.class.getName()},
			new String[] {"groupId", "lastPostDate"}, false);
