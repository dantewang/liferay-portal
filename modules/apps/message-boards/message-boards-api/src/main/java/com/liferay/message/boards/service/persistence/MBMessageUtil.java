...
public class MBMessageUtil {
	 ...
	 * @return the matching message-boards messages
	 */
	public static List<MBMessage> findByG_U_S_C_A(
		long groupId, long userId, int status, long categoryId,
		boolean anonymous) {

		return getPersistence().findByG_U_S_C_A(
	 ...
	 * @throws NoSuchMessageException if a matching message-boards message could not be found
	 */
	public static MBMessage findByG_U_S_C_A_First(
			long groupId, long userId, int status, long categoryId,
			boolean anonymous, OrderByComparator<MBMessage> orderByComparator)
		throws com.liferay.message.boards.exception.NoSuchMessageException {

		return getPersistence().findByG_U_S_C_A_First(
	 ...
	 * @return the first matching message-boards message, or <code>null</code> if a matching message-boards message could not be found
	 */
	public static MBMessage fetchByG_U_S_C_A_First(
		long groupId, long userId, int status, long categoryId,
		boolean anonymous, OrderByComparator<MBMessage> orderByComparator) {

		return getPersistence().fetchByG_U_S_C_A_First(
			groupId, userId, status, categoryId, anonymous, orderByComparator);
	}
	 ...
	 * @throws NoSuchMessageException if a matching message-boards message could not be found
	 */
	public static MBMessage findByG_U_S_C_A_Last(
			long groupId, long userId, int status, long categoryId,
			boolean anonymous, OrderByComparator<MBMessage> orderByComparator)
		throws com.liferay.message.boards.exception.NoSuchMessageException {

		return getPersistence().findByG_U_S_C_A_Last(
			groupId, userId, status, categoryId, anonymous, orderByComparator);
	}
	 ...
	 * @return the last matching message-boards message, or <code>null</code> if a matching message-boards message could not be found
	 */
	public static MBMessage fetchByG_U_S_C_A_Last(
		long groupId, long userId, int status, long categoryId,
		boolean anonymous, OrderByComparator<MBMessage> orderByComparator) {

		return getPersistence().fetchByG_U_S_C_A_Last(
			groupId, userId, status, categoryId, anonymous, orderByComparator);
	}
	 ...
	 * @throws NoSuchMessageException if a message-boards message with the primary key could not be found
	 */
	public static MBMessage[] findByG_U_S_C_A_PrevAndNext(
			long messageId, long groupId, long userId, int status,
			long categoryId, boolean anonymous,
			OrderByComparator<MBMessage> orderByComparator)
		throws com.liferay.message.boards.exception.NoSuchMessageException {

		return getPersistence().findByG_U_S_C_A_PrevAndNext(
	 ...
	 * @return the matching message-boards messages that the user has permission to view
	 */
	public static List<MBMessage> filterFindByG_U_S_C_A(
		long groupId, long userId, int status, long categoryId,
		boolean anonymous) {

		return getPersistence().filterFindByG_U_S_C_A(
			groupId, userId, status, categoryId, anonymous);
	}
	 ...
	 * @throws NoSuchMessageException if a message-boards message with the primary key could not be found
	 */
	public static MBMessage[] filterFindByG_U_S_C_A_PrevAndNext(
			long messageId, long groupId, long userId, int status,
			long categoryId, boolean anonymous,
			OrderByComparator<MBMessage> orderByComparator)
		throws com.liferay.message.boards.exception.NoSuchMessageException {

		return getPersistence().filterFindByG_U_S_C_A_PrevAndNext(
			messageId, groupId, userId, status, categoryId, anonymous,
			orderByComparator);
	}
	 ...
	 * @param anonymous the anonymous
	 */
	public static void removeByG_U_S_C_A(
		long groupId, long userId, int status, long categoryId,
		boolean anonymous) {

		getPersistence().removeByG_U_S_C_A(
			groupId, userId, status, categoryId, anonymous);
	}
	 ...
	 * @return the number of matching message-boards messages
	 */
	public static int countByG_U_S_C_A(
		long groupId, long userId, int status, long categoryId,
		boolean anonymous) {

		return getPersistence().countByG_U_S_C_A(
			groupId, userId, status, categoryId, anonymous);
	}
	 ...
	 * @return the number of matching message-boards messages that the user has permission to view
	 */
	public static int filterCountByG_U_S_C_A(
		long groupId, long userId, int status, long categoryId,
		boolean anonymous) {

		return getPersistence().filterCountByG_U_S_C_A(
			groupId, userId, status, categoryId, anonymous);
	}
