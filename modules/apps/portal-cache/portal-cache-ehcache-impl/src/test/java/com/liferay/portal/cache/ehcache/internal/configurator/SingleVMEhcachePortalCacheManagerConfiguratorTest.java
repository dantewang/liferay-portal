...
import com.liferay.portal.test.aspects.PropertiesUtilAdvice;
...
public class SingleVMEhcachePortalCacheManagerConfiguratorTest {
	...
	@AdviseWith(adviceClasses = PropertiesUtilAdvice.class)
	@NewEnv(type = NewEnv.Type.CLASSLOADER)
	@Test
	public void testParsePropertiesThrowable() throws Exception {
		IOException ioException = new IOException();

		PropertiesUtilAdvice.setReadThrowable(ioException);

		Class<?> clazz = Class.forName(
			"com.liferay.portal.cache.ehcache.internal.configurator." +
				"SingleVMEhcachePortalCacheManagerConfigurator");

		SingleVMEhcachePortalCacheManagerConfigurator
			singleVMEhcachePortalCacheManagerConfigurator =
				(SingleVMEhcachePortalCacheManagerConfigurator)clazz.
					newInstance();
