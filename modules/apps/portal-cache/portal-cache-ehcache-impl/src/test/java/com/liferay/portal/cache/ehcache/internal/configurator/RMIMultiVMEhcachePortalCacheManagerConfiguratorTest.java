...
public class RMIMultiVMEhcachePortalCacheManagerConfiguratorTest {
	...
	public void testActivate() {
		RMIMultiVMEhcachePortalCacheManagerConfigurator
			rmiMultiVMEhcachePortalCacheManagerConfigurator = _activate(false);
		...
		rmiMultiVMEhcachePortalCacheManagerConfigurator = _activate(true);
	...
	private RMIMultiVMEhcachePortalCacheManagerConfigurator _activate(
