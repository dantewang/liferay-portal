...
create index IX_F12A43F on Marketplace_App (uuid_[$COLUMN_LENGTH:75$], companyId);
...
create index IX_F0FC5DF2 on Marketplace_Module (uuid_[$COLUMN_LENGTH:75$], companyId);